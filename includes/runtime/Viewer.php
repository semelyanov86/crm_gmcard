...
class Vtiger_Viewer extends Smarty
{
    ...
    public const DEFAULTTHEME  = 'softed';
    ...
    public function __construct($media = '')
    {
        ...
        $classes = ['Vtiger_MenuStructure_Model', 'Users_Privileges_Model',
        ...
        $modifiers = ['vtranslate', 'vtlib_isModuleActive', 'vimage_path', 'strstr', 'stripos', 'strpos', 'date', 'vtemplate_path', 'vresource_url',
