...
class Vtiger_Cache
{
    ...
    {
        if (isset($picklistDetails, $field)) {
    ...
    private static $_workflows_of_inventory_supporting_product_qty_update = [];
     ...
     * @param type $block
     */
    public static function flushModuleBlocksCache($moduleInstance, $block = null)
    {
        if ($block == null) {
