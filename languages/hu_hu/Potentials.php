...
$languageStrings = [
    ...
    'Forecast Amount'              => 'Súlyozott Revenue',
    'Funnel'                       => 'Értékesítéi tölcsér',
    ...
    'Related To'                   => 'Szervezet neve',
    'Type'                         => 'Típus',

    // Convert Potentials
    'LBL_CONVERT_POTENTIAL'        => 'Convert lehetőségek',
    'LBL_POTENTIALS_FIELD_MAPPING' => 'Lehetőségek táblatérképezés',
    'LBL_CONVERT_POTENTIALS_ERROR' => 'Meg kell, hogy a Project konvertálni a lehetőség',
    'LBL_POTENTIALS_FIELD_MAPPING_INCOMPLETE' => 'Lehetőségek táblatérképezés hiányos (Settings> Module Manager> Lehetőségek> Lehetőségek táblatérképezés)',
    'LBL_CREATE_PROJECT' => 'Új projekt létrehozása',

    // Potentials Custom Field Mapping
    'LBL_CUSTOM_FIELD_MAPPING' => 'Lehetőség Projekthez feltérképezése',
...
$jsLanguageStrings = [
    'JS_SELECT_PROJECT_TO_CONVERT_LEAD' => 'Átalakítása igényli kiválasztása Project',
];
