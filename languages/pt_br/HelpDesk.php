 ...
 * All Rights Reserved. Contributor(s): Valmir Carlos Trindade | Brazilian Portuguese Translation - www.ttcasolucoes.com.br
 */
$languageStrings = [
    // Basic Strings
    'HelpDesk' => 'Chamados',
    ...
    'LBL_TICKET_RESOLUTION' => 'Resolução Chamado',

    // Field Labels
    'Ticket No' => 'Número Chamado',
    'Severity' => 'Gravidade',
    ...
    // DetailView Actions
    'LBL_CONVERT_FAQ' => 'Converte para FAQ',
    'LBL_RELATED_TO' => 'Relacionado a',

    // added to support i18n in Chamado mails
    ...
    'LBL_TICKET_DETAILS' => 'Detalhes Chamado',
    'LBL_SUBJECT' => 'Assunto: ',
    'created' => 'criado',
    'replied' => 'respondido',
    ...
    'LBL_GIVE_MAILID' => 'Por favor, informe seu e-mail',
    ...
    'LBL_MAIL_SENT' => 'A mensagem foi enviada para seu email com os detalhes de acesso ao Portal do Clientes',
    'LBL_ALTBODY' => 'Este é o corpo em texto puro para clientes de email não-HTML',
    'HelpDesk ID' => 'ID Chamado',
    // Portal shortcuts
    'LBL_ADD_DOCUMENT' => 'Adicionar Documento',
    'LBL_OPEN_TICKETS' => 'Abrir Chamado',
    'LBL_CREATE_TICKET' => 'Criar Chamado',
];

$jsLanguageStrings = [
    'LBL_ADD_DOCUMENT' => 'Adicionar Documento',
    'LBL_OPEN_TICKETS' => 'Abril Chamados',
    'LBL_CREATE_TICKET' => 'Criar Chamado',
];
