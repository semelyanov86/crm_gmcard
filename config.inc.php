...
$HELPDESK_SUPPORT_EMAIL_ID = 'adm@gmcard.ru';
...
$dbconfig['db_server'] = getenv('DB_HOST');
$dbconfig['db_port'] = ':' . getenv('DB_PORT');
$dbconfig['db_username'] = getenv('DB_USER');
...
$dbconfigoption['ssl'] = getenv('VTIGER_SSL');
...
$application_unique_key = '7d50fafe7e9c61dd383379c6412033d1';
