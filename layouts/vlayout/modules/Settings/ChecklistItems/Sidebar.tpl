...
{else}
    <div>
        <table cellspacing="0" cellpadding="5" border="0" width="98%">
            <tbody><tr>
                <td align="center"><img src="layouts/vlayout/skins/images/denied.gif"></td>
            </tr>
            <tr>
                <td align="center" nowrap="nowrap" style="border-bottom: 1px solid rgb(204, 204, 204);">
                    <span class="genHeaderSmall">{vtranslate('LBL_PERMISSION_DENIED', $QUALIFIED_MODULE)}</span>
                </td>
            </tr>
            <tr>
