...
{strip}
    <div class="fc-overlay-modal modal-content">
        <form id="exportForm" class="form-horizontal" method="post" action="index.php">
            ...
            <input type="hidden" name="ids_in_page" value={ZEND_JSON::encode($IDS_IN_PAGE)}>
            ...
            <div class="modal-overlay-footer clearfix">
                <div class="row clearfix">
                    <div class=" textAlignCenter col-lg-12 col-md-12 col-sm-12 ">
                        <div><button type="submit" class="btn btn-success btn-lg">{vtranslate('LBL_EXPORT', 'Vtiger')}&nbsp;{vtranslate($RELATED_MODULE, $RELATED_MODULE)}</button>
