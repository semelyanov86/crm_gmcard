...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/gm-avatar.png" />
        </div>
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/coupon1.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/coupon2.png">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/coupon3.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">GMCash CRM</h1>
                    <p>Делаем покупки выгоднее!</p>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 login-more-info vte-user-login">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 copy-right">
                            <small>GMCard all rights reserved</small>
                        </div>
                    </div>
                </div>
