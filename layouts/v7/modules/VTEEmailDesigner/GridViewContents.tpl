...
<div class="col-sm-12 col-xs-12 ">
	...
	<div class="table-container" style="padding:5px;border: 0px;">
            ...
            {foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=listview}
				...
				{assign var=TEMPLATE_PATH value={$MODULE_MODEL->getTemplatePath({$TEMPLATE_ID})}}
                 <li class="positionRel textCenter">
                    ...
                    <div class="thumbnail cursorPointer positionRel" data-value="{$TEMPLATE_ID}" data-label="{$TEMPLATE_NAME}" style='border: 1px solid #ddd;'>
                            <div class="imageDiv" style="height: 277px!important;overflow-y: auto;">
								<img src="test/template_imgfiles/{if !empty($TEMPLATE_PATH)}{$TEMPLATE_PATH}{else}default.png{/if}"  data-value="{$TEMPLATE_ID}" style="width:216px;height:217px;"/>
                            <div class="hide" style="display: block; width: 100%;position: absolute;bottom:0;">
								<a class="btn btn-default" style="width:99.5%;" data-id="{$LISTVIEW_ENTRY->getId()}" href="{$LISTVIEW_ENTRY->getEditViewUrl()}&isDuplicate=true">
									<i class="fa fa-files-o cursorPointer" title="{vtranslate('Duplicate', $MODULE)}" ></i>
