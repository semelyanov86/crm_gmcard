...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content" style="border-bottom: 1px solid #eee!important;">
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
				...
				{if $RECORD and $smarty.request.view eq 'Edit'}
					<p class="current-filter-name filter-name pull-left " ><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="{$RECORD->get('subject')}" style="max-width: 100%!important;">&nbsp;&nbsp;{vtranslate('LBL_EDITING', $MODULE)} : {$RECORD->get('subject')} &nbsp;&nbsp;</a></p>
