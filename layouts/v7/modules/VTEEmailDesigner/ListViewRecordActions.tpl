...
<div class="table-actions">
    ...
    <span class="more dropdown action">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a data-id="{$LISTVIEW_ENTRY->getId()}" class="previewTemplate" data-value="{$LISTVIEW_ENTRY->getId()}">{vtranslate('Preview', $MODULE)}</a></li>
            <li><a data-id="{$LISTVIEW_ENTRY->getId()}" href="{$LISTVIEW_ENTRY->getEditViewUrl()}&isDuplicate=true" target="_blank">{vtranslate('Duplicate', $MODULE)}</a></li>
        </ul>
    </span>
