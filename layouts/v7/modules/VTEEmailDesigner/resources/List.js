...
Vtiger_List_Js("VTEEmailDesigner_List_Js", {
    ...
    registerDeleteRecordClickEvent: function () {
        jQuery('#page').on('click', '.deleteRecordButton', function(e){
            ...
            VTEEmailDesigner_List_Js.deleteRecord(recordId);
        });
    },
    ...
    registerTemplateEditEvent: function () {
        jQuery('#listViewContent').on('click', '.imageDiv img,.editTemplate', function (e) {
            ...
            var redirectUrl = 'index.php?module=VTEEmailDesigner&view=Edit&recordid='+templateId;
    ...
    registerTemplateDuplicationEvent: function () {
        jQuery('#listViewContent').on('click', '.templateDuplication', function (e) {
            ...
            var redirectUrl = 'index.php?module=VTEEmailDesigner&view=Edit&record='+templateId+'&isDuplicate=true';
            window.location.href = redirectUrl;
        });
    },
    ...
    registerPreviewTemplateEvent: function(){
        var thisInstance = this;
        jQuery('body').on('click','.previewTemplate',function(e){
...
jQuery(document).ready(function() {
    jQuery('.app-trigger, .app-icon, .app-navigator').unbind('click');
