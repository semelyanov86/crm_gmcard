	...
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix">
			<span class="col-lg-7 col-md-7">
				...
				{/if}
				{if $DASHBOARD_BOARDS}
					<div style="text-align: right;padding-top: 4px" class="headerTabContainer">
							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu">
									{foreach item="childLink" from=$childLinks}
										...
										{elseif $childLink->getLabel() eq 'LBL_PIVOT'}
                                            {assign var="ICON_CLASS" value='fa fa-table'}
										{elseif $childLink->getLabel() eq 'LBL_SQL_REPORT'}
		...
		{assign var=FIELDS_INFO value=VReports_Field_Model::getListViewFieldsInfo()}
