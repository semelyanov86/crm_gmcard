...
{strip}
    ...
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                {if $deleteAction}
                    <button type="button" class="btn btn-default" id="{$MODULE}_listView_massAction_LBL_MOVE_REPORT" 
                            onclick='VReports_List_Js.massMove("index.php?module=VReports&view=MoveReports")' title="{vtranslate('LBL_MOVE_REPORT', $MODULE)}" disabled="disabled">
            ...
            <a href="index.php?module=VReports&view=DashBoard" class="btn btn-default">Dashboards</a>
            </div>
            <div class='col-md-4'>
