...
{elseif $REPORT_TYPE eq 'PivotEdit'}
    {include file="EditPivotHeader.tpl"|vtemplate_path:$MODULE}
{elseif $REPORT_TYPE eq 'SqlReportEdit'}
    {include file="SqlReportEditHeader.tpl"|vtemplate_path:$MODULE}
{else}
...
<div class="reportContents">
    <form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
        ...
        <input type=hidden id="relatedModules" data-value='{html_entity_decode(ZEND_JSON::encode($RELATED_MODULES))}' />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <select class="select2-container select2 col-lg-12 inputElement" id="primary_module" name="primary_module" data-rule-required="true"
                                ...
                                <option value="">{vtranslate('SELECT_AN_OPTION',$MODULE)}</option>
                ...
                <div class='form-group'>
                    ...
                    <div class='col-lg-4'>
                        <select id="memberList" class="col-lg-12 select2-container select2 members " multiple="true" name="members[]" data-placeholder="{vtranslate('LBL_ADD_USERS_ROLES', $MODULE)}">
                            <option data-member-type="ShareAll" value="ShareAll:1" {if $SELECTED_MEMBERS_SHARE_ALL eq '1'} selected="selected" {/if}>Everyone</option>
