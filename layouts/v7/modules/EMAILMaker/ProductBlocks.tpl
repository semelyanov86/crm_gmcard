                                    ...
                                    <div class="pull-right actions">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default editProductBlock ProductBlockBtn" data-url="index.php?module={$MODULE}&view=EditProductBlock&tplid={$tpl_id}" data-tplid="{$tpl_id}">
                                                <i title="{vtranslate('LBL_EDIT','PDFMaker')}" class="fa fa-pencil"></i>
                                            </button>
                                            <button type="button" class="btn btn-default duplicateProductBlock ProductBlockBtn" data-url="index.php?module=PDFMaker&view=EditProductBlock&tplid={$tpl_id}&mode=duplicate" data-tplid="{$tpl_id}">{vtranslate('LBL_DUPLICATE','PDFMaker')}</button>
