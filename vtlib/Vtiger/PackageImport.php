...
class Vtiger_PackageImport extends Vtiger_PackageExport
{
        ...
        if ($module != null) {
            ...
            $unzip->unzipAllEx(
                ...
                [
                    ...
                    'include' => ['templates', "modules/{$module}", 'cron', 'languages', 'settings',
     ...
     */
    public function import_Tables($modulenode, $moduleInstance = false)
    {
     ...
     */
    public function import_mandatoryFields($blocknode, $blockInstance, $moduleInstance)
    {
