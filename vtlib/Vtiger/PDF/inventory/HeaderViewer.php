...
class Vtiger_PDF_InventoryHeaderViewer extends Vtiger_PDF_HeaderViewer
{
    ...
    public function display($parent)
    {
        ...
        if ($this->model) {
            ...
            [$imageWidth, $imageHeight, $imageType, $imageAttr] = $parent->getimagesize(
                $modelColumn0['logo'],
            );
            ...
            $pdf->MultiCell(
                $headerColumnWidth,
                $contentHeight,
                $modelColumn0['summary'],
                0,
                'L',
                0,
                1,
                $headerFrame->x,
                $headerFrame->y + $imageHeightInMM + 2,
            );
            ...
            $pdf->RoundedRect($roundedRectX, 10, $roundedRectW, 10, 3, '1111', 'DF', [], [205, 201, 201]);
                ...
                if (is_array($value)) {
                    ...
                    foreach ($value as $l => $v) {
                        $pdf->MultiCell(
                            ...
                            0,
                            1,
                            $headerFrame->x + $headerColumnWidth * 2.0 + $offsetX,
                            $pdf->GetY() + $offsetY,
                        );
                        $offsetY = 0;
                    }
                    ...
                    if ($label == 'Shipping Address') {
                        ...
                        $pdf->MultiCell(
                            ...
                            1,
                            1,
                            $headerFrame->x + $headerColumnWidth,
                            $pdf->GetY() + $offsetY,
                        );
