...
class PurchaseOrder extends CRMEntity
{
    ...
    public $tab_name = ['vtiger_crmentity', 'vtiger_purchaseorder', 'vtiger_pobillads', 'vtiger_poshipads', 'vtiger_purchaseordercf', 'vtiger_inventoryproductrel'];

    public $tab_name_index = ['vtiger_crmentity' => 'crmid', 'vtiger_purchaseorder' => 'purchaseorderid', 'vtiger_pobillads' => 'pobilladdressid', 'vtiger_poshipads' => 'poshipaddressid', 'vtiger_purchaseordercf' => 'purchaseorderid', 'vtiger_inventoryproductrel' => 'id'];
     ...
     */
    public function getSubProductsQty($productId)
    {
        $subProductQtys = [];
    ...
    public function get_postatushistory($id)
    {
        ...
        $postatus_array = ($postatus_access != 1) ? $picklistarray['postatus'] : [];
    ...
    public function generateReportsSecQuery($module, $secmodule, $queryPlanner)
    {
        ...
        $matrix->setDependency('vtiger_purchaseorder', ['vtiger_crmentityPurchaseOrder', "vtiger_currency_info{$secmodule}",
    ...
    {
        $rel_tables =  [
            'Calendar' => ['vtiger_seactivityrel' => ['crmid', 'activityid'], 'vtiger_purchaseorder' => 'purchaseorderid'],
