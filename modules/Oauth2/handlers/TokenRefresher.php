        ...
        if ($db->num_rows($rs)) {
            ...
            if (isset($tokens['refresh_token'])) {
                ...
                try {
                    ...
                    $provider = new GenericProvider($cfg);
                    ...
                    $db->pquery(
                        ...
                        [$newpassword, $newexpireson, $record['id']],
                    );
        ...
        while ($record = $db->fetch_array($rs)) {
            ...
            if (isset($tokens['refresh_token'])) {
                ...
                switch ($record['server']) {
                    case 'imap.gmail.com': $svc = 'Google';
                        break;
                ...
                try {
                    ...
                    $db->pquery(
                        ...
                        [$newpassword, $newexpireson, $record['scannerid']],
                    );
            ...
            if (isset($tokens['refresh_token'])) {
                ...
                try {
                    ...
                    $db->pquery(
                        ...
                        [$newpassword, $newexpireson, $record['mail_username'], $record['account_id'], $record['user_id']],
                    );
