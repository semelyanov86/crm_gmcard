...
class VTEAdvanceMenu_Uninstall_View extends Settings_Vtiger_Index_View
{
    public function removeData()
    {
        global $adb;
        $message = "";
        $result = $adb->pquery("DROP TABLE IF EXISTS vte_advance_menu_settings_groups;", array());
        $result = $adb->pquery("DROP TABLE IF EXISTS vte_advance_menu_settings_menu;", array());
        $result = $adb->pquery("DROP TABLE IF EXISTS vte_advance_menu_settings_menu_groups_rel;", array());
        $result = $adb->pquery("DROP TABLE IF EXISTS vte_advance_menu_settings_menu_items;", array());
