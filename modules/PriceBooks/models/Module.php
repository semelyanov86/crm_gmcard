...
class PriceBooks_Module_Model extends Vtiger_Module_Model
{
    ...
    {
        $relatedModulesList = ['Products', 'Services'];
    ...
    public function getAdditionalImportFields()
    {
        if (!$this->importableFields) {
            $fieldHeaders = [
                'relatedto' => ['label' => 'Related To', 'uitype' => 10], // For relation field
                'listprice' => ['label' => 'ListPrice', 'uitype' => 83], // For related field currency
            ];
