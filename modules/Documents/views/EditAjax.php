...
class Documents_EditAjax_View extends Vtiger_QuickCreateAjax_View
{
    ...
    {
        switch ($documentType) {
            case 'I': case 'E': return ['filename', 'assigned_user_id', 'folderid'];
            case 'W': return ['notes_title', 'assigned_user_id', 'folderid', 'filename', 'fileversion'];
        }
    }
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        if ($documentType == 'W') {
            ...
            $fieldsToEliminate = ['document_source', 'createdtime', 'modifiedtime', 'filetype', 'filesize', 'filedownloadcount', 'folderid', 'note_no', 'modifiedby', 'created_user_id'];
