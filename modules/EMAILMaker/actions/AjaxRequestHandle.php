    ...
    public function process(Vtiger_Request $request)
    {
        ...
        switch ($request->get('handler')) {
            ...
            case 'templates_order':
                ...
                $sqlA = 'INSERT INTO vtiger_emakertemplates_userstatus(templateid, userid, is_active, is_default, sequence) VALUES ';
                $sqlB = '';
                $params = [];
            ...
            case 'custom_labels_edit':
                ...
                $adb->pquery('INSERT INTO vtiger_emakertemplates_label_vals(label_id, lang_id, label_value) VALUES(?,?,?)', [$request->get('label_id'), $request->get('lang_id'), $request->get('label_value')]);
                break;
            case 'fill_relblocks':
            ...
            case 'delete_relblock':
                $record = addslashes($request->get('relblockid'));
                $adb->pquery('UPDATE vtiger_emakertemplates_relblocks SET deleted = 1 WHERE relblockid = ?', [$record]);
                break;
        }
    }
}
