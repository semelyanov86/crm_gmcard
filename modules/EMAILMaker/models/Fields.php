...
class EMAILMaker_Fields_Model extends Vtiger_Base_Model
{
            ...
            if (count($block_fields) > 0) {
                ...
                while ($row1 = $adb->fetchByAssoc($result1)) {
                    ...
                    if ($module == 'Calendar') {
                        ...
                        if (!isset($Existing_ModuleFields[$option_key])) {
    ...
    public static function getDateOptions()
    {
        return [
            ...
            '##HH:II##' => vtranslate('LBL_TIME_HH:II:SS', 'EMAILMaker'),
        ];
    }
    ...
    public static function getDefaultFromOptions()
    {
        ...
        $result1 = $adb->pquery('SELECT * FROM vtiger_systems WHERE from_email_field != ? AND server_type = ?', ['', 'email']);
