...
class EMAILMaker_Popup_View extends Vtiger_Popup_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if ($request->has('src_record') && !$request->isEmpty('src_record')) {
            $listViewModel->set('src_record', $request->get('src_record'));
        }
    ...
    public function getListViewCount(Vtiger_Request $request)
    {
        ...
        $listViewModel = EMAILMaker_ListView_Model::getInstance($moduleName);
        $listViewModel->set('search_key', $searchKey);
        $listViewModel->set('search_value', $searchValue);
