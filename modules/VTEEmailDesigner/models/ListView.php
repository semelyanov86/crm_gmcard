...
{
    private $querySelectColumns = ['templatename, foldername, subject', 'systemtemplate', 'module', 'description'];
    ...
    public function getListViewMassActions($linkParams)
    {
        ...
        $links = [];
        $massActionLinks[] = ['linktype' => 'LISTVIEWMASSACTION', 'linklabel' => 'LBL_DELETE', 'linkurl' => 'javascript:VTEEmailDesigner_List_Js.massDeleteRecords("index.php?module=' . $moduleModel->get('name') . '&action=MassDelete");', 'linkicon' => ''];
    ...
    public function getListViewLinks($linkParams)
    {
        ...
        $basicLinks = [['linktype' => 'LISTVIEWBASIC', 'linklabel' => 'LBL_ADD_RECORD', 'linkurl' => $moduleModel->getCreateRecordUrl(), 'linkicon' => '']];
