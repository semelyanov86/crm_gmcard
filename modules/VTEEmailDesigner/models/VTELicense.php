...
class VTEEmailDesigner_VTELicense_Model
{
    public $module = "";
    ...
    public function readLicenseFile()
    {
        ...
        try {
            ...
            $client = new SoapClient("http://license.vtexperts.com/license/soap.php?wsdl", array("trace" => 1, "exceptions" => 0, "cache_wsdl" => WSDL_CACHE_NONE, "stream_context" => stream_context_create(array("ssl" => array("verify_peer" => false, "verify_peer_name" => false, "allow_self_signed" => true)))));
    ...
    public function checkValidate()
    {
        ...
        try {
            $client = new SoapClient("http://license.vtexperts.com/license/soap.php?wsdl", array("trace" => 1, "exceptions" => 0, "stream_context" => stream_context_create(array("ssl" => array("verify_peer" => false, "verify_peer_name" => false, "allow_self_signed" => true)))));
            $arr = $client->validate($data);
            $this->result = $arr["result"];
            $this->message = $arr["message"];
            $this->expiration_date = $arr["expiration_date"];
