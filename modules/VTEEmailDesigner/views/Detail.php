...
class VTEEmailDesigner_Detail_View extends Vtiger_Index_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $jsFileNames = array("modules.Vtiger.resources.Detail", "modules.VTEEmailDesigner.resources.Detail", "modules.Settings.Vtiger.resources.Index", "~layouts/v7/lib/jquery/Lightweight-jQuery-In-page-Filtering-Plugin-instaFilta/instafilta.min.js");
