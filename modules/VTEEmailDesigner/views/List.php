...
class VTEEmailDesigner_List_View extends Vtiger_Index_View
{
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~layouts/" . Vtiger_Viewer::getDefaultLayoutName() . "/lib/jquery/perfect-scrollbar/css/perfect-scrollbar.css");
