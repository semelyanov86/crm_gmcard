...
class Vtiger_ExtensionViews_View extends Vtiger_Index_View
{
     ...
     * @retun <array> $data
     */
    public function convertDataToUserFormat($logData)
    {
        $data = [];
     ...
     * @return <array> $data
     */
    public function convertLogDetailsToUserFormat($logDetails, $moduleName)
    {
        ...
        foreach ($logDetails as $logId) {
            if (!is_numeric($logId)) {
                [$moduleId, $recordId] = explode('x', $logId);
                if ($logId && $moduleId) {
    ...
    public function getDetailViewLink($moduleName, $recordId)
    {
     ...
     * @return <boolean> true/false
     */
    public function checkIsSyncReady()
    {
        return true;
    }

    public function showLogs(Vtiger_Request $request)
    {
    ...
    public function showLogDetail(Vtiger_Request $request)
    {
