...
class Vtiger_Field_Model extends Vtiger_Field
{
    ...
    public const OWNER_TYPE = 'owner';
    public const OWNERGROUP_TYPE = 'group';
    public const CURRENCY_LIST = 'currencyList';
    public const QUICKCREATE_MANDATORY = 0;
    public const QUICKCREATE_NOT_ENABLED = 1;
    public const QUICKCREATE_ENABLED = 2;
    public const QUICKCREATE_NOT_PERMITTED = 3;
    public const DISPLAYTYPE_ALL = 1;
    public const DISPLAYTYPE_DETAIL_AND_LIST = 2; // e.g. Created time, Modified time
    public const DISPLAYTYPE_LIST = 3; // e.g. Total, Subtotal in Inventory modules
    public const DISPLAYTYPE_PASSWORD = 4;
    public const DISPLAYTYPE_LINEITEM = 5;
    public const DISPLAYTYPE_STARRED = 6; // show on List View and as separate button on Detail View
    public const PRESENCE_ALWAYS_VISIBLE = 0; // cannot be hidden by user
    public const PRESENCE_HIDDEN = 1;
    public const PRESENCE_VISIBLE = 2; // can be hidden by user

    // UITYPES
    public const UITYPE_TEXT = 1;
    public const UITYPE_NAME = 2;
    public const UITYPE_RECORD_NO = 4; // auto increment
    public const UITYPE_DATE = 5;
    public const UITYPE_ACTIVITY_DATE_START = 6;
    public const UITYPE_NUMERIC = 7; // same for float and integer
    public const UITYPE_EMAIL_RECIPIENT_ADDRESS = 8;
    public const UITYPE_PERCENTAGE = 9;
    public const UITYPE_RECORD_RELATION = 10;
    public const UITYPE_PHONE = 11;
    public const UITYPE_FROM_EMAIL = 12;
    public const UITYPE_EMAIL = 13;
    public const UITYPE_TIME = 14;
    public const UITYPE_ROLE_BASED_PICKLIST = 15;
    public const UITYPE_PICKLIST = 16; // non-role based picklist
    public const UITYPE_URL = 17;
    public const UITYPE_FULL_WIDTH_TEXT_AREA = 19;
    public const UITYPE_FAQ = 20;
    public const UITYPE_HALF_WIDTH_TEXT_AREA = 21;
    public const UITYPE_TICKET_TITLE = 22;
    public const UITYPE_DATE_2 = 23;
    public const UITYPE_STREET_ADDRESS = 24;
    public const UITYPE_COUNTER = 25; // e.g. click count & access count
    public const UITYPE_FOLDER_NAME = 26;
    public const UITYPE_DOWNLOAD_TYPE = 27;
    public const UITYPE_FILENAME = 28;
    public const UITYPE_ACTIVITY_SEND_REMINDER = 30;
    public const UITYPE_MULTI_SELECT = 33;
    public const UITYPE_ACCOUNT_REFERENCE = 51;
    public const UITYPE_USER_REFERENCE = 52; // e.g. assigned to
    public const UITYPE_ASSIGNED_TO_PICKLIST = 53;
    public const UITYPE_SALUTATION_OR_FIRSTNAME = 55;
    public const UITYPE_CHECKBOX = 56;
    public const UITYPE_CONTACT = 57;
    public const UITYPE_CAMPAIGN_REFERENCE = 58;
    public const UITYPE_PRODUCT_REFERENCE = 59;
    public const UITYPE_ATTACHMENT = 61;
    public const UITYPE_ACTIVITY_DURATION = 63;
    public const UITYPE_ACTIVITY_PARENT_REFERENCE = 66;
    public const UITYPE_IMAGE = 69; // e.g. product image & contact image
    public const UITYPE_DATE_TIME = 70;
    public const UITYPE_CURRENCY_AMOUNT = 71;
    public const UITYPE_LINEITEMS_CURRENCY_AMOUNT = 72;
    public const UITYPE_ACCOUNT_REFERENCE_2 = 73;
    public const UITYPE_POTENTIAL_REFERENCE = 76;
    public const UITYPE_QUOTES_INVENTORY_MANAGER = 77;
    public const UITYPE_QUOTES_REFERENCE = 78;
    public const UITYPE_SALESORDER_REFERENCE = 80;
    public const UITYPE_VENDOR_REFERENCE = 81;
    public const UITYPE_TAX = 83;
    public const UITYPE_SKYPE = 85;
    public const UITYPE_CURRENCY_CODE = 117; // picklist with currencies
    public const UITYPE_LASTNAME = 255; // last name in contacts and leads
    public const UITYPE_EMAIL_PARENT_RECORD = 357;

    // UITYPES for Users module
    public const UITYPE_USER_ACCESS_KEY = 3;
    public const UITYPE_USER_THEME = 31;
    public const UITYPE_USER_PICKLIST = 32;
    public const UITYPE_USER_ROLE = 98;
    public const UITYPE_USER_PASSWORD = 98;
    public const UITYPE_USER_REPORTS_TO = 101;
    public const UITYPE_USER_EMAIL = 104;
    public const UITYPE_USER_USERNAME = 106;
    public const UITYPE_USER_STATUS = 115;
    public const UITYPE_USER_END_HOUR = 116;
    public const UITYPE_USER_IS_ADMIN = 156;
    ...
    {
        if (substr_count($this->get('typeofdata'), '~') == 0) {
            $this->set('typeofdata', $this->get('typeofdata') . '~');
        }
