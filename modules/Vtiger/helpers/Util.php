...
class Vtiger_Util_Helper
{
    ...
    public static function formatDateTimeIntoDayString($dateTime, $skipConversion = false)
    {
        ...
        if (substr_count($dateTimeInUserFormat, ' ') == 1) {
            $dateTimeInUserFormat .= ' ';
        } // init for meridiem if not present
    ...
    {
        $pickListIds = ['opportunity_type' => 'opptypeid',
    ...
    {
        return ceil(vglobal('upload_maxsize') / (1_024 * 1_024));
    }
    ...
    {
        return self::getMaxUploadSize() * 1_024 * 1_024;
    }
    ...
    */
    ...
    {
        return ['alphagrey' => '#666666', 'softed'	=> '#1560BD', 'bluelagoon' => '#204E81',
    ...
    */
    ...
    public static function checkDbLocalInfileSupport()
    {
        ...
        while ($arr = $db->fetch_array($rs)) {
            switch ($arr['variable_name']) {
                case 'local_infile': $db_local_infile = $arr['value'];
                    break;
            }
    ...
    public static function toJsonWithUnescapedUtf8($data)
    {
        ...
        $unescapedUtf8Json = preg_replace_callback('/\\\u([0-9a-f]{4})/i', static function ($matches) {
    ...
    public static function validateFieldValue($fieldValue, $fieldModel)
    {
        ...
        $editablePicklistValues = $fieldInfo['editablepicklistvalues'] ?? null;
