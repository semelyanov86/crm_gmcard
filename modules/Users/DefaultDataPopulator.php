...
class DefaultDataPopulator extends CRMEntity
{
    ...
    public function DefaultDataPopulator()
    {
        self::__construct();
    }
    ...
    public function create_tables()
    {
        ...
        $blockres = $this->db->pquery($blockquery, ['LBL_EMAIL_INFORMATION']);
        ...
        $def_org_tabid = [2, 4, 6, 7, 8, 9, 10, 13, 14, 16, 20, 21, 22, 23, 26];
...
Should any need arise,please do give us a call.';
    ...
    public function vtws_addEntityInfo()
    {
        ...
        foreach ($names as $tab) {
            if (in_array($tab, ['Rss', 'Webmails', 'Recyclebin'])) {
                continue;
            }
        ...
        vtws_addDefaultActorTypeEntity('Groups', ['fieldNames' => 'groupname',
        ...
        vtws_addDefaultActorTypeEntity('Currency', ['fieldNames' => 'currency_name',
        ...
        vtws_addDefaultActorTypeEntity('DocumentFolders', ['fieldNames' => 'foldername',
    ...
    {
        $fieldTypeInfo = ['picklist' => [15, 16], 'text' => [19, 20, 21, 24], 'autogenerated' => [3], 'phone' => [11],
            'multipicklist' => [33], 'url' => [17], 'skype' => [85], 'boolean' => [56, 156], 'owner' => [53],
            'file' => [61, 28], 'email' => [13], 'currency' => [71, 72]];
    ...
    {
        $referenceMapping = ['50' => ['Accounts'], '51' => ['Accounts'], '57' => ['Contacts'],
            '58' => ['Campaigns'], '73' => ['Accounts'], '75' => ['Vendors'], '76' => ['Potentials'],
            '78' => ['Quotes'], '80' => ['SalesOrder'], '81' => ['Vendors'], '101' => ['Users'], '52' => ['Users'],
            '357' => ['Contacts', 'Accounts', 'Leads', 'Users', 'Vendors'], '59' => ['Products'],
            '66' => ['Leads', 'Accounts', 'Potentials', 'HelpDesk', 'Campaigns'], '77' => ['Users'], '68' => ['Contacts', 'Accounts'],
            '117' => ['Currency'], '26' => ['DocumentFolders'], '10' => []];
    ...
    public function addEntriesForSettings()
    {
        ...
        $name_blocks = ['LBL_USERS' => 'LBL_USER_MANAGEMENT',
        ...
        $description = ['LBL_USER_DESCRIPTION',
    ...
    public function addDefaultLeadMapping()
    {
        ...
        $fieldMap = [
            ...
            ['country', 'bill_country', 'mailingcountry', null, 1],
            ...
            ['country', 'ship_country', null, null, 1],
