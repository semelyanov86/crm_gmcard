...
class Users_List_View extends Settings_Vtiger_List_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer)
    {
        ...
        if ($request->get('mode') == 'removeAlphabetSearch') {
            Vtiger_ListView_Model::deleteParamsSession($moduleName . '_' . $cvId, ['search_key', 'search_value', 'operator']);
            $searchKey = '';
            $searchValue = '';
            $operator = '';
        }
    ...
    public function setModuleInfo($request, $moduleModel)
    {
        ...
        $linkParams = ['MODULE' => $moduleModel->getName(), 'ACTION' => $request->get('view')];
