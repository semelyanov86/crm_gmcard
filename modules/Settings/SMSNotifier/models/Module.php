...
class Settings_SMSNotifier_Module_Model extends Settings_Vtiger_Module_Model
{
    ...
    public $listFields = ['providertype' => 'Provider', 'username' => 'User Name', 'isactive' => 'Active'];
    ...
    {
        $fieldsList = [
            ['name' => 'providertype', 'label' => 'Provider', 'type' => 'picklist'],
            ['name' => 'isactive', 'label' => 'Active', 'type' => 'radio'],
        ];
     ...
     */
    public static function deleteRecords($recordIdsList = [])
    {
        if ($recordIdsList) {
