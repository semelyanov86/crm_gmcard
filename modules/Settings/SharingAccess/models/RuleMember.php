...
{
    public const RULE_MEMBER_TYPE_GROUPS = 'Groups';
    public const RULE_MEMBER_TYPE_ROLES = 'Roles';
    public const RULE_MEMBER_TYPE_ROLE_AND_SUBORDINATES = 'RoleAndSubordinates';
