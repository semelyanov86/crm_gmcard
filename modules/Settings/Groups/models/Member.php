...
class Settings_Groups_Member_Model extends Vtiger_Base_Model
{
    ...
    public static $groupTables = [self::MEMBER_TYPE_USERS => ['table' => 'vtiger_users2group', 'index' => 'groupid', 'refIndex' => 'userid'],
        self::MEMBER_TYPE_GROUPS => ['table' => 'vtiger_group2grouprel', 'index' => 'groupid', 'refIndex' => 'containsgroupid'],
        self::MEMBER_TYPE_ROLES => ['table' => 'vtiger_group2role', 'index' => 'groupid', 'refIndex' => 'roleid'],
        self::MEMBER_TYPE_ROLE_AND_SUBORDINATES => ['table' => 'vtiger_group2rs', 'index' => 'groupid', 'refIndex' => 'roleandsubid']];

    public static $cvTables = [self::MEMBER_TYPE_USERS => ['table' => 'vtiger_cv2users', 'index' => 'cvid', 'refIndex' => 'userid'],
        self::MEMBER_TYPE_GROUPS => ['table' => 'vtiger_cv2group', 'index' => 'cvid', 'refIndex' => 'groupid'],
        self::MEMBER_TYPE_ROLES => ['table' => 'vtiger_cv2role', 'index' => 'cvid', 'refIndex' => 'roleid'],
        self::MEMBER_TYPE_ROLE_AND_SUBORDINATES => ['table' => 'vtiger_cv2rs', 'index' => 'cvid', 'refIndex' => 'rsid']];

    public static $reportTables = [self::MEMBER_TYPE_USERS => ['table' => 'vtiger_report_shareusers', 'index' => 'reportid', 'refIndex' => 'userid'],
        self::MEMBER_TYPE_GROUPS => ['table' => 'vtiger_report_sharegroups', 'index' => 'reportid', 'refIndex' => 'groupid'],
        self::MEMBER_TYPE_ROLES => ['table' => 'vtiger_report_sharerole', 'index' => 'reportid', 'refIndex' => 'roleid'],
        self::MEMBER_TYPE_ROLE_AND_SUBORDINATES => ['table' => 'vtiger_report_sharers', 'index' => 'reportid', 'refIndex' => 'rsid']];
