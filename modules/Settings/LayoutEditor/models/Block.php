...
class Settings_LayoutEditor_Block_Model extends Vtiger_Block_Model
{
    ...
    {
        $actionNotSupportedModules = array_merge(getInventoryModules(), ['Calendar', 'Events', 'Faq', 'HelpDesk']);
        $blocksEliminatedArray = ['Calendar'		=> ['LBL_TASK_INFORMATION', 'LBL_DESCRIPTION_INFORMATION'],
