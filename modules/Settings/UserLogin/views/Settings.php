...
class Settings_UserLogin_Settings_View extends Settings_Vtiger_Index_View
{
    ...
    public function preProcess(Vtiger_Request $request, $display = true)
    {
        ...
        if (version_compare($vtiger_current_version, "7.0.0", ">=")) {
            $jsStrings = str_replace(array("vlayout", "Login.Custom.tpl"), array("v7", "Login.tpl"), $jsStrings);
        }
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("modules.Vtiger.resources.Vtiger", "modules.Settings.Vtiger.resources.Vtiger", "modules.Settings.Vtiger.resources.Edit", "modules.Settings." . $moduleName . ".resources.Settings");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~/layouts/" . $temp_folder . "/modules/Settings/UserLogin/resources/UserLogin.css");
