...
{
    public static $EXTENSION_LOOKUP_URL = false;

    public static $EXTENSION_MANAGER_URL = false;
    ...
    public function installTrackDetails()
    {
        ...
        $client->setHeaders(['Referer' => vglobal('site_URL')]);
    ...
    public static function getInstanceFromXMLNodeObject($extensionXMLNode)
    {
        ...
        foreach ($objectProperties as $propertyName => $propertyValue) {
            ...
            if ($propertyName === 'description') {
                $propertyValue = nl2br(str_replace(['<', '>'], ['&lt;', '&gt;'], br2nl(trim($propertyValue))));
            }
