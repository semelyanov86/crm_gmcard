...
class Settings_ChecklistItems_Settings_View extends Settings_Vtiger_Index_View
{
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = ['~/layouts/v7/modules/Settings/ChecklistItems/resources/ChecklistItems.css', '~/layouts/v7/lib/jquery/webui-popover/dist/jquery.webui-popover.min.css'];
