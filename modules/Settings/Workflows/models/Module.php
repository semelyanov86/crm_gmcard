...
class Settings_Workflows_Module_Model extends Settings_Vtiger_Module_Model
{
    ...
    public $listFields = ['module_name' => 'Module', 'workflowname' => 'Workflow Name', 'summary' => 'Description', 'execution_condition' => 'Trigger', 'test' => 'Conditions'];
