...
class VTEConditionalAlerts_TaskRecord_Model extends Vtiger_Record_Model
{
    ...
    public function save()
    {
        ...
        if (empty($recordId)) {
            ...
            $adb->pquery($sql, array($_REQUEST["for_cap"], $action_title, $alert_while_edit, $alert_when_open, $alert_on_save, $donot_allow_to_save, $description, 1));
            ...
            $adb->pquery($sql, array($_REQUEST["for_cap"], $action_title, $alert_while_edit, $alert_when_open, $alert_on_save, $donot_allow_to_save, $description, $recordId));
        }
        return $recordId;
    }
