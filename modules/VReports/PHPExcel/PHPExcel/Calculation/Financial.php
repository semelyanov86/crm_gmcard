...
class PHPExcel_Calculation_Financial
{
     ...
     * @return    float
     */
    public static function ACCRINT($issue, $firstinterest, $settlement, $rate, $par = 1_000, $frequency = 1, $basis = 0)
    {
        ...
        $par        = (is_null($par)) ? 1_000 : PHPExcel_Calculation_Functions::flattenSingleValue($par);
     ...
     * @return    float
     */
    public static function ACCRINTM($issue, $settlement, $rate, $par = 1_000, $basis = 0)
    {
        $issue        = PHPExcel_Calculation_Functions::flattenSingleValue($issue);
        $settlement    = PHPExcel_Calculation_Functions::flattenSingleValue($settlement);
        $rate        = PHPExcel_Calculation_Functions::flattenSingleValue($rate);
