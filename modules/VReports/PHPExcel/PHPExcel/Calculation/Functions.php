...
/** 2 / PI */
define('M_2DIVPI', 0.636_619_772_367_581_343_075_535_053_490_06);
...
if ((!function_exists('mb_str_replace'))
    ...
    function mb_str_replace($search, $replace, $subject)
    {
        ...
        foreach ((array) $search as $key => $s) {
            ...
            while ($pos !== false) {
                $subject = mb_substr($subject, 0, $pos, 'UTF-8') . $r . mb_substr($subject, $pos + mb_strlen($s, 'UTF-8'), 65_535, 'UTF-8');
