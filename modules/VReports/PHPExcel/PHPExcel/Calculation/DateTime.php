...
class PHPExcel_Calculation_DateTime
{
    ...
    public static function DATETIMENOW()
    {
        ...
        switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
            ...
            case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT:
                $retValue = new DateTimeImmutable();
                break;
        }
    ...
    public static function DATE($year = 0, $month = 1, $day = 1)
    {
        ...
        // Validate parameters
        if ($year < ($baseYear - 1_900)) {
            return PHPExcel_Calculation_Functions::NaN();
        }
        if ((($baseYear - 1_900) != 0) && ($year < $baseYear) && ($year >= 1_900)) {
            return PHPExcel_Calculation_Functions::NaN();
        }

        if (($year < $baseYear) && ($year >= ($baseYear - 1_900))) {
            $year += 1_900;
        }
    ...
    public static function TIME($hour = 0, $minute = 0, $second = 0)
    {
        ...
        switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
            ...
            case PHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC:
                return (int) PHPExcel_Shared_Date::ExcelToPHP(PHPExcel_Shared_Date::FormattedPHPToExcel(1_970, 1, 1, $hour, $minute, $second));    // -2147468400; //    -2147472000 + 3600
            case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT:
                $dayAdjust = 0;
                if ($hour < 0) {
                ...
                $phpDateObject = new DateTimeImmutable('1900-01-01 ' . $hour . ':' . $minute . ':' . $second);
                if ($dayAdjust != 0) {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            ...
            switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
                ...
                case PHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC:
                    return (int) PHPExcel_Shared_Date::ExcelToPHP($excelDateValue);
                case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT:
                    return new DateTimeImmutable($PHPDateArray['year'] . '-' . $PHPDateArray['month'] . '-' . $PHPDateArray['day'] . ' 00:00:00');
            }
        }
    ...
    public static function TIMEVALUE($timeValue)
    {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            if (PHPExcel_Calculation_Functions::getCompatibilityMode() == PHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE) {
                ...
                $excelDateValue = PHPExcel_Shared_Date::FormattedPHPToExcel(1_900, 1, 1, $PHPDateArray['hour'], $PHPDateArray['minute'], $PHPDateArray['second']) - 1;
            }
            ...
            switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
                case PHPExcel_Calculation_Functions::RETURNDATE_EXCEL:
                    return (float) $excelDateValue;
                case PHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC:
                    return (int) $phpDateValue = PHPExcel_Shared_Date::ExcelToPHP($excelDateValue + 25_569) - 3_600;
                case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT:
                    return new DateTimeImmutable('1900-01-01 ' . $PHPDateArray['hour'] . ':' . $PHPDateArray['minute'] . ':' . $PHPDateArray['second']);
            }
        }
    ...
    public static function DAYOFWEEK($dateValue = 1, $style = 1)
    {
        ...
        if (PHPExcel_Calculation_Functions::getCompatibilityMode() == PHPExcel_Calculation_Functions::COMPATIBILITY_EXCEL) {
            ...
            if (($PHPDateObject->format('Y') == 1_900) && ($PHPDateObject->format('n') <= 2)) {
                --$DoW;
                if ($DoW < $firstDay) {
                    $DoW += 7;
                }
