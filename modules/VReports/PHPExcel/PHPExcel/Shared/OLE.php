...
class PHPExcel_Shared_OLE
{
    ...
    public const OLE_DATA_SIZE_SMALL = 0x10_00;
    ...
    public static function LocalDate2OLE($date = null)
    {
        ...
        $days = 134_774;
        // calculate seconds
        $big_date = $days * 24 * 3_600 + gmmktime(date('H', $date), date('i', $date), date('s', $date), date('m', $date), date('d', $date), date('Y', $date));
