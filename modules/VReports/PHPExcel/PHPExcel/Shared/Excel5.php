...
class PHPExcel_Shared_Excel5
{
    ...
    public static function getDistanceX(PHPExcel_Worksheet $sheet, $startColumn = 'A', $startOffsetX = 0, $endColumn = 'A', $endOffsetX = 0)
    {
        ...
        $distanceX -= (int) floor(self::sizeCol($sheet, $startColumn) * $startOffsetX / 1_024);

        // correct for offsetX in endcell
        $distanceX -= (int) floor(self::sizeCol($sheet, $endColumn) * (1 - $endOffsetX / 1_024));
    ...
    public static function oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height)
    {
        ...
        $x1 = $x1     / self::sizeCol($sheet, PHPExcel_Cell::stringFromColumnIndex($col_start))   * 1_024;
        $y1 = $y1     / self::sizeRow($sheet, $row_start + 1)   *  256;
        $x2 = ($width + 1)  / self::sizeCol($sheet, PHPExcel_Cell::stringFromColumnIndex($col_end))     * 1_024; // Distance to right side of object
