...
class PHPExcel_Shared_Drawing
{
    ...
    {
        if ($pValue != 0) {
            return (int) ceil($pValue * 1.333_333_333);
        }
    ...
    {
        return (int) round($pValue * 60_000);
    }
