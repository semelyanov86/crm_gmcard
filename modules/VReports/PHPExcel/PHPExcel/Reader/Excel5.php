...
{
    // ParseXL definitions
    public const XLS_BIFF8                     = 0x06_00;
    public const XLS_BIFF7                     = 0x05_00;
    public const XLS_WorkbookGlobals           = 0x00_05;
    public const XLS_Worksheet                 = 0x00_10;

    // record identifiers
    public const XLS_TYPE_FORMULA              = 0x00_06;
    public const XLS_TYPE_EOF                  = 0x00_0A;
    public const XLS_TYPE_PROTECT              = 0x00_12;
    public const XLS_TYPE_OBJECTPROTECT        = 0x00_63;
    public const XLS_TYPE_SCENPROTECT          = 0x00_DD;
    public const XLS_TYPE_PASSWORD             = 0x00_13;
    public const XLS_TYPE_HEADER               = 0x00_14;
    public const XLS_TYPE_FOOTER               = 0x00_15;
    public const XLS_TYPE_EXTERNSHEET          = 0x00_17;
    public const XLS_TYPE_DEFINEDNAME          = 0x00_18;
    public const XLS_TYPE_VERTICALPAGEBREAKS   = 0x00_1A;
    public const XLS_TYPE_HORIZONTALPAGEBREAKS = 0x00_1B;
    public const XLS_TYPE_NOTE                 = 0x00_1C;
    public const XLS_TYPE_SELECTION            = 0x00_1D;
    public const XLS_TYPE_DATEMODE             = 0x00_22;
    public const XLS_TYPE_EXTERNNAME           = 0x00_23;
    public const XLS_TYPE_LEFTMARGIN           = 0x00_26;
    public const XLS_TYPE_RIGHTMARGIN          = 0x00_27;
    public const XLS_TYPE_TOPMARGIN            = 0x00_28;
    public const XLS_TYPE_BOTTOMMARGIN         = 0x00_29;
    public const XLS_TYPE_PRINTGRIDLINES       = 0x00_2B;
    public const XLS_TYPE_FILEPASS             = 0x00_2F;
    public const XLS_TYPE_FONT                 = 0x00_31;
    public const XLS_TYPE_CONTINUE             = 0x00_3C;
    public const XLS_TYPE_PANE                 = 0x00_41;
    public const XLS_TYPE_CODEPAGE             = 0x00_42;
    public const XLS_TYPE_DEFCOLWIDTH          = 0x00_55;
    public const XLS_TYPE_OBJ                  = 0x00_5D;
    public const XLS_TYPE_COLINFO              = 0x00_7D;
    public const XLS_TYPE_IMDATA               = 0x00_7F;
    public const XLS_TYPE_SHEETPR              = 0x00_81;
    public const XLS_TYPE_HCENTER              = 0x00_83;
    public const XLS_TYPE_VCENTER              = 0x00_84;
    public const XLS_TYPE_SHEET                = 0x00_85;
    public const XLS_TYPE_PALETTE              = 0x00_92;
    public const XLS_TYPE_SCL                  = 0x00_A0;
    public const XLS_TYPE_PAGESETUP            = 0x00_A1;
    public const XLS_TYPE_MULRK                = 0x00_BD;
    public const XLS_TYPE_MULBLANK             = 0x00_BE;
    public const XLS_TYPE_DBCELL               = 0x00_D7;
    public const XLS_TYPE_XF                   = 0x00_E0;
    public const XLS_TYPE_MERGEDCELLS          = 0x00_E5;
    public const XLS_TYPE_MSODRAWINGGROUP      = 0x00_EB;
    public const XLS_TYPE_MSODRAWING           = 0x00_EC;
    public const XLS_TYPE_SST                  = 0x00_FC;
    public const XLS_TYPE_LABELSST             = 0x00_FD;
    public const XLS_TYPE_EXTSST               = 0x00_FF;
    public const XLS_TYPE_EXTERNALBOOK         = 0x01_AE;
    public const XLS_TYPE_DATAVALIDATIONS      = 0x01_B2;
    public const XLS_TYPE_TXO                  = 0x01_B6;
    public const XLS_TYPE_HYPERLINK            = 0x01_B8;
    public const XLS_TYPE_DATAVALIDATION       = 0x01_BE;
    public const XLS_TYPE_DIMENSION            = 0x02_00;
    public const XLS_TYPE_BLANK                = 0x02_01;
    public const XLS_TYPE_NUMBER               = 0x02_03;
    public const XLS_TYPE_LABEL                = 0x02_04;
    public const XLS_TYPE_BOOLERR              = 0x02_05;
    public const XLS_TYPE_STRING               = 0x02_07;
    public const XLS_TYPE_ROW                  = 0x02_08;
    public const XLS_TYPE_INDEX                = 0x02_0B;
    public const XLS_TYPE_ARRAY                = 0x02_21;
    public const XLS_TYPE_DEFAULTROWHEIGHT     = 0x02_25;
    public const XLS_TYPE_WINDOW2              = 0x02_3E;
    public const XLS_TYPE_RK                   = 0x02_7E;
    public const XLS_TYPE_STYLE                = 0x02_93;
    public const XLS_TYPE_FORMAT               = 0x04_1E;
    public const XLS_TYPE_SHAREDFMLA           = 0x04_BC;
    public const XLS_TYPE_BOF                  = 0x08_09;
    public const XLS_TYPE_SHEETPROTECTION      = 0x08_67;
    public const XLS_TYPE_RANGEPROTECTION      = 0x08_68;
    public const XLS_TYPE_SHEETLAYOUT          = 0x08_62;
    public const XLS_TYPE_XFEXT                = 0x08_7D;
    public const XLS_TYPE_PAGELAYOUTVIEW       = 0x08_8B;
    public const XLS_TYPE_UNKNOWN              = 0xFF_FF;
    ...
    public const REKEY_BLOCK                   = 0x4_00;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $offsetX = $startOffsetX * PHPExcel_Shared_Excel5::sizeCol($this->phpSheet, $startColumn) / 1_024;
                    ...
                    switch ($obj['otObjType']) {
                        ...
                        case 0x08:
                            ...
                            $BSEindex = $spContainer->getOPT(0x01_04);
                            ...
                            if (count($explodes) == 2) {
                                if ($docSheet = $this->phpExcel->getSheetByName($explodes[0])) {
                                    ...
                                    if (count($coordinateStrings) == 2) {
                                        ...
                                        } elseif ($firstRow == 1 and $lastRow == 65_536) {
     ...
     * @var string       Salt data
     * @var string Hashed salt data
    ...
    private function readFont()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $isItalic = (0x00_02 & self::getInt2d($recordData, 2)) >> 1;
            if ($isItalic) {
            ...
            $isStrike = (0x00_08 & self::getInt2d($recordData, 2)) >> 3;
            if ($isStrike) {
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($this->version == self::XLS_BIFF8) {
                ...
                if ($bordersLeftStyle = PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_00_0F & self::getInt4d($recordData, 10)) >> 0)) {
                    $objStyle->getBorders()->getLeft()->setBorderStyle($bordersLeftStyle);
                }
                // bit: 7-4; mask: 0x000000F0; right style
                if ($bordersRightStyle = PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_00_F0 & self::getInt4d($recordData, 10)) >> 4)) {
                    $objStyle->getBorders()->getRight()->setBorderStyle($bordersRightStyle);
                }
                // bit: 11-8; mask: 0x00000F00; top style
                if ($bordersTopStyle = PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_0F_00 & self::getInt4d($recordData, 10)) >> 8)) {
                    $objStyle->getBorders()->getTop()->setBorderStyle($bordersTopStyle);
                }
                // bit: 15-12; mask: 0x0000F000; bottom style
                if ($bordersBottomStyle = PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_F0_00 & self::getInt4d($recordData, 10)) >> 12)) {
                    $objStyle->getBorders()->getBottom()->setBorderStyle($bordersBottomStyle);
                }
                // bit: 22-16; mask: 0x007F0000; left color
                $objStyle->getBorders()->getLeft()->colorIndex = (0x00_7F_00_00 & self::getInt4d($recordData, 10)) >> 16;

                // bit: 29-23; mask: 0x3F800000; right color
                $objStyle->getBorders()->getRight()->colorIndex = (0x3F_80_00_00 & self::getInt4d($recordData, 10)) >> 23;

                // bit: 30; mask: 0x40000000; 1 = diagonal line from top left to right bottom
                $diagonalDown = (0x40_00_00_00 & self::getInt4d($recordData, 10)) >> 30 ? true : false;

                // bit: 31; mask: 0x80000000; 1 = diagonal line from bottom left to top right
                $diagonalUp = (0x80_00_00_00 & self::getInt4d($recordData, 10)) >> 31 ? true : false;
                ...
                $objStyle->getBorders()->getTop()->colorIndex = (0x00_00_00_7F & self::getInt4d($recordData, 14)) >> 0;

                // bit: 13-7; mask: 0x00003F80; bottom color
                $objStyle->getBorders()->getBottom()->colorIndex = (0x00_00_3F_80 & self::getInt4d($recordData, 14)) >> 7;

                // bit: 20-14; mask: 0x001FC000; diagonal color
                $objStyle->getBorders()->getDiagonal()->colorIndex = (0x00_1F_C0_00 & self::getInt4d($recordData, 14)) >> 14;

                // bit: 24-21; mask: 0x01E00000; diagonal style
                if ($bordersDiagonalStyle = PHPExcel_Reader_Excel5_Style_Border::lookup((0x01_E0_00_00 & self::getInt4d($recordData, 14)) >> 21)) {
                    $objStyle->getBorders()->getDiagonal()->setBorderStyle($bordersDiagonalStyle);
                }

                // bit: 31-26; mask: 0xFC000000 fill pattern
                if ($fillType = PHPExcel_Reader_Excel5_Style_FillPattern::lookup((0xFC_00_00_00 & self::getInt4d($recordData, 14)) >> 26)) {
                    $objStyle->getFill()->setFillType($fillType);
                }
                // offset: 18; size: 2; pattern and background colour
                // bit: 6-0; mask: 0x007F; color index for pattern color
                $objStyle->getFill()->startcolorIndex = (0x00_7F & self::getInt2d($recordData, 18)) >> 0;

                // bit: 13-7; mask: 0x3F80; color index for pattern background
                $objStyle->getFill()->endcolorIndex = (0x3F_80 & self::getInt2d($recordData, 18)) >> 7;
            } else {
                // BIFF5
                ...
                $objStyle->getFill()->startcolorIndex = (0x00_00_00_7F & $borderAndBackground) >> 0;

                // bit: 13-7; mask: 0x00003F80; color index for pattern background
                $objStyle->getFill()->endcolorIndex = (0x00_00_3F_80 & $borderAndBackground) >> 7;

                // bit: 21-16; mask: 0x003F0000; fill pattern
                $objStyle->getFill()->setFillType(PHPExcel_Reader_Excel5_Style_FillPattern::lookup((0x00_3F_00_00 & $borderAndBackground) >> 16));

                // bit: 24-22; mask: 0x01C00000; bottom line style
                $objStyle->getBorders()->getBottom()->setBorderStyle(PHPExcel_Reader_Excel5_Style_Border::lookup((0x01_C0_00_00 & $borderAndBackground) >> 22));

                // bit: 31-25; mask: 0xFE000000; bottom line color
                $objStyle->getBorders()->getBottom()->colorIndex = (0xFE_00_00_00 & $borderAndBackground) >> 25;

                // offset: 12; size: 4; cell border lines
                $borderLines = self::getInt4d($recordData, 12);

                // bit: 2-0; mask: 0x00000007; top line style
                $objStyle->getBorders()->getTop()->setBorderStyle(PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_00_07 & $borderLines) >> 0));

                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()->getLeft()->setBorderStyle(PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_00_38 & $borderLines) >> 3));

                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()->getRight()->setBorderStyle(PHPExcel_Reader_Excel5_Style_Border::lookup((0x00_00_01_C0 & $borderLines) >> 6));

                // bit: 15-9; mask: 0x0000FE00; top line color index
                $objStyle->getBorders()->getTop()->colorIndex = (0x00_00_FE_00 & $borderLines) >> 9;

                // bit: 22-16; mask: 0x007F0000; left line color index
                $objStyle->getBorders()->getLeft()->colorIndex = (0x00_7F_00_00 & $borderLines) >> 16;

                // bit: 29-23; mask: 0x3F800000; right line color index
                $objStyle->getBorders()->getRight()->colorIndex = (0x3F_80_00_00 & $borderLines) >> 23;
            }
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $xfIndex = (0x0F_FF & $ixfe) >> 0;

            // bit: 15; mask 0x8000; 0 = user-defined style, 1 = built-in style
            $isBuiltIn = (bool) ((0x80_00 & $ixfe) >> 15);
    ...
    private function readExternalBook()
    {
        ...
        } elseif (substr($recordData, 0, 4) == pack('vCC', 0x00_01, 0x01, 0x3A)) {
            // add-in function
            // offset: 0; size: 2; 0x0001
            $this->externalBooks[] = [
                'type' => 'addInFunction',
            ];
        } elseif (substr($recordData, 0, 2) == pack('v', 0x00_00)) {
            // DDE links, OLE links
    ...
    private function readSheetPr()
    {
        ...
        $isSummaryBelow = (0x00_40 & self::getInt2d($recordData, 0)) >> 6;
        $this->phpSheet->setShowSummaryBelow($isSummaryBelow);

        // bit: 7; mask: 0x0080; 0 = outline buttons left of outline group
        $isSummaryRight = (0x00_80 & self::getInt2d($recordData, 0)) >> 7;
        $this->phpSheet->setShowSummaryRight($isSummaryRight);

        // bit: 8; mask: 0x100; 0 = scale printout in percent, 1 = fit printout to number of pages
        // this corresponds to radio button setting in page setup dialog in Excel
        $this->isFitToPages = (bool) ((0x01_00 & self::getInt2d($recordData, 0)) >> 8);
    }
    ...
    private function readPageSetup()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $isPortrait = (0x00_02 & self::getInt2d($recordData, 10)) >> 1;

            // bit: 2; mask: 0x0004; 1= paper size, scaling factor, paper orient. not init
            // when this bit is set, do not use flags for those properties
            $isNotInit = (0x00_04 & self::getInt2d($recordData, 10)) >> 2;
    ...
    private function readColInfo()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $isHidden = (0x00_01 & self::getInt2d($recordData, 8)) >> 0;

            // bit: 10-8; mask: 0x0700; outline level of the columns (0 = no outline)
            $level = (0x07_00 & self::getInt2d($recordData, 8)) >> 8;

            // bit: 12; mask: 0x1000; 1 = collapsed
            $isCollapsed = (0x10_00 & self::getInt2d($recordData, 8)) >> 12;
    ...
    private function readRow()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $height = (0x7F_FF & self::getInt2d($recordData, 6)) >> 0;

            // bit: 15: mask: 0x8000; 0 = row has custom height; 1= row has default height
            $useDefaultHeight = (0x80_00 & self::getInt2d($recordData, 6)) >> 15;
            ...
            $level = (0x00_00_00_07 & self::getInt4d($recordData, 12)) >> 0;
            $this->phpSheet->getRowDimension($r + 1)->setOutlineLevel($level);

            // bit: 4; mask: 0x00000010; 1 = outline group start or ends here... and is collapsed
            $isCollapsed = (0x00_00_00_10 & self::getInt4d($recordData, 12)) >> 4;
            $this->phpSheet->getRowDimension($r + 1)->setCollapsed($isCollapsed);

            // bit: 5; mask: 0x00000020; 1 = row is hidden
            $isHidden = (0x00_00_00_20 & self::getInt4d($recordData, 12)) >> 5;
            $this->phpSheet->getRowDimension($r + 1)->setVisible(!$isHidden);

            // bit: 7; mask: 0x00000080; 1 = row has explicit format
            $hasExplicitFormat = (0x00_00_00_80 & self::getInt4d($recordData, 12)) >> 7;

            // bit: 27-16; mask: 0x0FFF0000; only applies when hasExplicitFormat = 1; index to XF record
            $xfIndex = (0x0F_FF_00_00 & self::getInt4d($recordData, 12)) >> 16;
    ...
    private function readFormula()
    {
        ...
        $isPartOfSharedFormula = (bool) (0x00_08 & $options);
    ...
    private function readWindow2()
    {
        ...
        $showGridlines = (bool) ((0x00_02 & $options) >> 1);
        $this->phpSheet->setShowGridlines($showGridlines);

        // bit: 2; mask: 0x0004; 0 = do not show headers, 1 = show headers
        $showRowColHeaders = (bool) ((0x00_04 & $options) >> 2);
        $this->phpSheet->setShowRowColHeaders($showRowColHeaders);

        // bit: 3; mask: 0x0008; 0 = panes are not frozen, 1 = panes are frozen
        $this->frozen = (bool) ((0x00_08 & $options) >> 3);

        // bit: 6; mask: 0x0040; 0 = columns from left to right, 1 = columns from right to left
        $this->phpSheet->setRightToLeft((bool) ((0x00_40 & $options) >> 6));

        // bit: 10; mask: 0x0400; 0 = sheet not active, 1 = sheet active
        $isActive = (bool) ((0x04_00 & $options) >> 10);
        if ($isActive) {
            $this->phpExcel->setActiveSheetIndex($this->phpExcel->getIndex($this->phpSheet));
        }

        // bit: 11; mask: 0x0800; 0 = normal view, 1 = page break view
        $isPageBreakPreview = (bool) ((0x08_00 & $options) >> 11);
    ...
    private function readHyperLink()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $isFileLinkOrUrl = (0x00_00_00_01 & self::getInt2d($recordData, 28)) >> 0;

            // bit: 1; mask: 0x00000002; 0 = relative path, 1 = absolute path or URL
            $isAbsPathOrUrl = (0x00_00_00_01 & self::getInt2d($recordData, 28)) >> 1;

            // bit: 2 (and 4); mask: 0x00000014; 0 = no description
            $hasDesc = (0x00_00_00_14 & self::getInt2d($recordData, 28)) >> 2;

            // bit: 3; mask: 0x00000008; 0 = no text, 1 = has text
            $hasText = (0x00_00_00_08 & self::getInt2d($recordData, 28)) >> 3;

            // bit: 7; mask: 0x00000080; 0 = no target frame, 1 = has target frame
            $hasFrame = (0x00_00_00_80 & self::getInt2d($recordData, 28)) >> 7;

            // bit: 8; mask: 0x00000100; 0 = file link or URL, 1 = UNC path (inc. server name)
            $isUNC = (0x00_00_01_00 & self::getInt2d($recordData, 28)) >> 8;
    ...
    private function readDataValidation()
    {
        ...
        $errorStyle = (0x00_00_00_70 & $options) >> 4;
        switch ($errorStyle) {
            case 0x00:
        ...
        $explicitFormula = (0x00_00_00_80 & $options) >> 7;

        // bit: 8; mask: 0x00000100; 1= empty cells allowed
        $allowBlank = (0x00_00_01_00 & $options) >> 8;

        // bit: 9; mask: 0x00000200; 1= suppress drop down arrow in list type validity
        $suppressDropDown = (0x00_00_02_00 & $options) >> 9;

        // bit: 18; mask: 0x00040000; 1= show prompt box if cell selected
        $showInputMessage = (0x00_04_00_00 & $options) >> 18;

        // bit: 19; mask: 0x00080000; 1= show error box if invalid values entered
        $showErrorMessage = (0x00_08_00_00 & $options) >> 19;

        // bit: 20-23; mask: 0x00F00000; condition operator
        $operator = (0x00_F0_00_00 & $options) >> 20;
        switch ($operator) {
            case 0x00:
    ...
    private function readSheetProtection()
    {
        ...
        $bool = (0x00_01 & $options) >> 0;
        $this->phpSheet->getProtection()->setObjects(!$bool);

        // bit: 1; mask 0x0002; edit scenarios
        $bool = (0x00_02 & $options) >> 1;
        $this->phpSheet->getProtection()->setScenarios(!$bool);

        // bit: 2; mask 0x0004; format cells
        $bool = (0x00_04 & $options) >> 2;
        $this->phpSheet->getProtection()->setFormatCells(!$bool);

        // bit: 3; mask 0x0008; format columns
        $bool = (0x00_08 & $options) >> 3;
        $this->phpSheet->getProtection()->setFormatColumns(!$bool);

        // bit: 4; mask 0x0010; format rows
        $bool = (0x00_10 & $options) >> 4;
        $this->phpSheet->getProtection()->setFormatRows(!$bool);

        // bit: 5; mask 0x0020; insert columns
        $bool = (0x00_20 & $options) >> 5;
        $this->phpSheet->getProtection()->setInsertColumns(!$bool);

        // bit: 6; mask 0x0040; insert rows
        $bool = (0x00_40 & $options) >> 6;
        $this->phpSheet->getProtection()->setInsertRows(!$bool);

        // bit: 7; mask 0x0080; insert hyperlinks
        $bool = (0x00_80 & $options) >> 7;
        $this->phpSheet->getProtection()->setInsertHyperlinks(!$bool);

        // bit: 8; mask 0x0100; delete columns
        $bool = (0x01_00 & $options) >> 8;
        $this->phpSheet->getProtection()->setDeleteColumns(!$bool);

        // bit: 9; mask 0x0200; delete rows
        $bool = (0x02_00 & $options) >> 9;
        $this->phpSheet->getProtection()->setDeleteRows(!$bool);

        // bit: 10; mask 0x0400; select locked cells
        $bool = (0x04_00 & $options) >> 10;
        $this->phpSheet->getProtection()->setSelectLockedCells(!$bool);

        // bit: 11; mask 0x0800; sort cell range
        $bool = (0x08_00 & $options) >> 11;
        $this->phpSheet->getProtection()->setSort(!$bool);

        // bit: 12; mask 0x1000; auto filter
        $bool = (0x10_00 & $options) >> 12;
        $this->phpSheet->getProtection()->setAutoFilter(!$bool);

        // bit: 13; mask 0x2000; pivot tables
        $bool = (0x20_00 & $options) >> 13;
        $this->phpSheet->getProtection()->setPivotTables(!$bool);

        // bit: 14; mask 0x4000; select unlocked cells
        $bool = (0x40_00 & $options) >> 14;
    ...
    private function readContinue()
    {
        ...
        $validSplitPoints = [0xF0_03, 0xF0_04, 0xF0_0D]; // add identifiers if we find more
    ...
    private function readBIFF8CellAddress($cellAddressStructure)
    {
        ...
        $column = PHPExcel_Cell::stringFromColumnIndex(0x00_FF & self::getInt2d($cellAddressStructure, 2));

        // bit: 14; mask 0x4000; (1 = relative column index, 0 = absolute column index)
        if (!(0x40_00 & self::getInt2d($cellAddressStructure, 2))) {
            $column = '$' . $column;
        }
        // bit: 15; mask 0x8000; (1 = relative row index, 0 = absolute row index)
        if (!(0x80_00 & self::getInt2d($cellAddressStructure, 2))) {
            $row = '$' . $row;
        }
    ...
    private function readBIFF8CellAddressB($cellAddressStructure, $baseCell = 'A1')
    {
        ...
        // offset: 2; size: 2; index to column or column offset + relative flags
        // bit: 7-0; mask 0x00FF; column index
        $colIndex = 0x00_FF & self::getInt2d($cellAddressStructure, 2);
        ...
        if (!(0x80_00 & self::getInt2d($cellAddressStructure, 2))) {
            ...
            $rowIndex = ($rowIndex <= 32_767) ? $rowIndex : $rowIndex - 65_536;
    ...
    private function readBIFF8CellRangeAddress($subData)
    {
        ...
        // bit: 7-0; mask 0x00FF; column index
        $fc = PHPExcel_Cell::stringFromColumnIndex(0x00_FF & self::getInt2d($subData, 4));

        // bit: 14; mask 0x4000; (1 = relative column index, 0 = absolute column index)
        if (!(0x40_00 & self::getInt2d($subData, 4))) {
            $fc = '$' . $fc;
        }

        // bit: 15; mask 0x8000; (1 = relative row index, 0 = absolute row index)
        if (!(0x80_00 & self::getInt2d($subData, 4))) {
            $fr = '$' . $fr;
        }
        ...
        // bit: 7-0; mask 0x00FF; column index
        $lc = PHPExcel_Cell::stringFromColumnIndex(0x00_FF & self::getInt2d($subData, 6));

        // bit: 14; mask 0x4000; (1 = relative column index, 0 = absolute column index)
        if (!(0x40_00 & self::getInt2d($subData, 6))) {
            $lc = '$' . $lc;
        }

        // bit: 15; mask 0x8000; (1 = relative row index, 0 = absolute row index)
        if (!(0x80_00 & self::getInt2d($subData, 6))) {
            $lr = '$' . $lr;
        }
    ...
    private function readBIFF8CellRangeAddressB($subData, $baseCell = 'A1')
    {
        ...
        // bit: 7-0; mask 0x00FF; column index
        $fcIndex = 0x00_FF & self::getInt2d($subData, 4);
        ...
        if (!(0x80_00 & self::getInt2d($subData, 4))) {
            ...
            // row offset
            $frIndex = ($frIndex <= 32_767) ? $frIndex : $frIndex - 65_536;
            $fr = $baseRow + $frIndex;
        }
        ...
        // bit: 7-0; mask 0x00FF; column index
        $lcIndex = 0x00_FF & self::getInt2d($subData, 6);
        ...
        if (!(0x80_00 & self::getInt2d($subData, 6))) {
            ...
            // row offset
            $lrIndex = ($lrIndex <= 32_767) ? $lrIndex : $lrIndex - 65_536;
            $lr = $baseRow + $lrIndex;
        }
        ...
        if (isset($this->ref[$index])) {
            ...
            switch ($type) {
                case 'internal':
                    ...
                    if ($this->ref[$index]['firstSheetIndex'] == 0xFF_FF or $this->ref[$index]['lastSheetIndex'] == 0xFF_FF) {
    ...
    private static function extractNumber($data)
    {
        ...
        $sign = ($rknumhigh & 0x80_00_00_00) >> 31;
        $exp = (($rknumhigh & 0x7F_F0_00_00) >> 20) - 1_023;
        $mantissa = (0x10_00_00 | ($rknumhigh & 0x00_0F_FF_FF));
        $mantissalow1 = ($rknumlow & 0x80_00_00_00) >> 31;
        $mantissalow2 = ($rknumlow & 0x7F_FF_FF_FF);
    ...
    private static function getIEEE754($rknum)
    {
        if (($rknum & 0x02) != 0) {
            ...
            $sign = ($rknum & 0x80_00_00_00) >> 31;
            $exp = ($rknum & 0x7F_F0_00_00) >> 20;
            $mantissa = (0x10_00_00 | ($rknum & 0x00_0F_FF_FC));
            $value = $mantissa / pow(2, 20 - ($exp - 1_023));
            if ($sign) {
                $value = -1 * $value;
            }
