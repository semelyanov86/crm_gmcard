...
class VReports_DetailView_Model extends Vtiger_DetailView_Model
{
    ...
    public function getDetailViewLinks($linkParams = "")
    {
        ...
        if ($printPermission) {
            if ($linkParams == "chart") {
                $detailViewLinks[] = array("linklabel" => vtranslate("LBL_PRINT_CHART", $moduleName), "linkicon" => "print.png", "onlick" => "VReports_ChartDetail_Js.printAndExportChat(this)", "mode" => "print");
            } else {
        ...
        if ($exportPermission && $primaryModuleExportPermission) {
            if ($linkParams == "chart") {
                $detailViewLinks[] = array("linklabel" => vtranslate("LBL_EXPORT_PDF", $moduleName), "linkicon" => "pdf.png", "onlick" => "VReports_ChartDetail_Js.printAndExportChat(this)", "mode" => "pdf");
            } else {
