...
class VReports_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    public function removeData($moduleName)
    {
        ...
        $result = $adb->pquery("DROP TABLE vtevreports_settings", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_schedulevreports table.";
        $result = $adb->pquery("DROP TABLE vtiger_schedulevreports", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_relcriteria table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_relcriteria", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_relcriteria_grouping table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_relcriteria_grouping", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_relcriteria_grouping_parent table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_relcriteria_grouping_parent", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_shareall table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_shareall", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_sharegroups table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_sharegroups", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_sharerole table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_sharerole", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_sharers table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_sharers", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport_shareusers table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport_shareusers", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportdatefilter table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportdatefilter", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportfilters table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportfilters", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportgroupbycolumn table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportgroupbycolumn", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportmodules table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportmodules", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportsharing table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportsharing", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportsortcol table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportsortcol", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportsummary table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportsummary", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreporttype table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreporttype", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_module_vreportdashboard_widgets table.";
        $result = $adb->pquery("DROP TABLE vtiger_module_vreportdashboard_widgets", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportdashboard_tabs table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportdashboard_tabs", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        ...
        $result = $adb->pquery("DROP TABLE vtiger_scheduled_vreports", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportfolder table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportfolder", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportshistory table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportshistory", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreportdashboard_boards table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreportdashboard_boards", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreports_css_defaults table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreports_css_defaults", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>&nbsp;&nbsp;- Delete vtiger_vreport table.";
        $result = $adb->pquery("DROP TABLE vtiger_vreport", array());
        echo $result ? " - DONE" : " - <b>ERROR</b>";
        echo "<br>";
