...
class VReports_List_View extends Vtiger_Index_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request)
    {
        ...
        if (!empty($searchParams)) {
            ...
            foreach ($searchParams as $conditions) {
                list($fieldname, $comparator, $searchValue) = $conditions;
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~layouts/" . Vtiger_Viewer::getDefaultLayoutName() . "/lib/jquery/perfect-scrollbar/css/perfect-scrollbar.css", "~layouts/v7/modules/VReports/resources/styleVReport.css", "~layouts/v7/modules/VReports/resources/List.css");
