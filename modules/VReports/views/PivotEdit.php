...
class VReports_PivotEdit_View extends Vtiger_Edit_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = ['~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js', 'modules.VReports.resources.Edit', 'modules.VReports.resources.Edit1', 'modules.VReports.resources.Edit2', 'modules.VReports.resources.Edit3', 'modules.' . $moduleName . '.resources.ChartEdit3', 'modules.' . $moduleName . '.resources.PivotEdit', 'modules.' . $moduleName . '.resources.PivotEdit1', 'modules.' . $moduleName . '.resources.PivotEdit2', 'modules.' . $moduleName . '.resources.PivotEdit3', 'modules.' . $moduleName . '.resources.PivotEdit4', 'modules.VReports.resources.CkEditor'];
