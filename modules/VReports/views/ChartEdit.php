...
class VReports_ChartEdit_View extends Vtiger_Edit_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.VReports.resources.Edit", "modules.VReports.resources.Edit1", "modules.VReports.resources.Edit2", "modules.VReports.resources.Edit3", "modules." . $moduleName . ".resources.ChartEdit", "modules." . $moduleName . ".resources.ChartEdit1", "modules." . $moduleName . ".resources.ChartEdit2", "modules." . $moduleName . ".resources.ChartEdit3", "modules.VReports.resources.CkEditor");
