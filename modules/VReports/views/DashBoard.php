...
class VReports_DashBoard_View extends Vtiger_Index_View
{
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $headerCss = array("~/layouts/v7/modules/VReports/resources/gridstack/gridstack.min.css", "~/layouts/v7/modules/VReports/resources/gridstack/gridstack-extra.min.css", "~/layouts/v7/modules/VReports/resources/jbPivot/jbPivot.css", "~/layouts/v7/modules/VReports/resources/StyleDashboard.css", "~libraries/jquery/colorpicker/css/colorpicker.css", "~/layouts/v7/modules/VReports/resources/perfect-scrollbar/css/perfect-scrollbar.css");
