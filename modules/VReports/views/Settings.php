...
class VReports_Settings_View extends Settings_Vtiger_Index_View
{
    ...
    public function renderSettingsUI(Vtiger_Request $request)
    {
        ...
        $module = $request->getModule();
        $viewer = $this->getViewer($request);
        $rs = $adb->pquery("SELECT `enable` FROM `vtevreports_settings`;", array());
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~layouts/v7/modules/VReports/resources/List.css");
