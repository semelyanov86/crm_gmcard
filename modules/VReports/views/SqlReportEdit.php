...
class VReports_SqlReportEdit_View extends Vtiger_Edit_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("modules.VReports.resources.Edit", "modules.VReports.resources.Edit1", "modules.VReports.resources.Edit2", "modules." . $moduleName . ".resources.SqlReportEdit", "modules." . $moduleName . ".resources.SqlReportEdit1", "modules." . $moduleName . ".resources.SqlReportEdit2", "~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.VReports.resources.CkEditor");
