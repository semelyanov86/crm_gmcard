...
class VReports_Edit_View extends Vtiger_Edit_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("modules." . $moduleName . ".resources.Edit1", "modules." . $moduleName . ".resources.Edit2", "modules." . $moduleName . ".resources.Edit3", "~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.VReports.resources.CkEditor");
