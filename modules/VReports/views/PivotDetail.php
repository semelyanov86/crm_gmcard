...
class VReports_PivotDetail_View extends Vtiger_Index_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("modules.Vtiger.resources.Detail", "modules." . $moduleName . ".resources.Detail", "modules." . $moduleName . ".resources.Edit", "modules." . $moduleName . ".resources.Edit1", "modules." . $moduleName . ".resources.Edit3", "modules." . $moduleName . ".resources.PivotEdit", "modules." . $moduleName . ".resources.PivotEdit2", "modules." . $moduleName . ".resources.PivotEdit3", "modules." . $moduleName . ".resources.PivotDetail", "modules." . $moduleName . ".resources.ChartDetail");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~/layouts/v7/modules/VReports/resources/jbPivot/jbPivot.css", "~/layouts/v7/modules/VReports/resources/exportPivot/orb.css", "~layouts/v7/modules/VReports/resources/styleVReport.css");
