...
class VReports_DashboardActions_Action extends Vtiger_Action_Controller
{
    ...
    public function updatePositionWidgets(Vtiger_Request $request)
    {
        ...
        foreach ($widgets as $widgetData) {
            ...
            $adb->pquery("UPDATE vtiger_module_vreportdashboard_widgets SET `position` = ?, `sizeWidth` = ?, `sizeHeight` = ? ,widthPx = ? WHERE id = ?", array($position, $width, $height, $widthPx, $widgetId));
        }
