...
class Invoice extends CRMEntity
{
    ...
    public $tab_name_index = ['vtiger_crmentity' => 'crmid', 'vtiger_invoice' => 'invoiceid', 'vtiger_invoicebillads' => 'invoicebilladdressid', 'vtiger_invoiceshipads' => 'invoiceshipaddressid', 'vtiger_invoicecf' => 'invoiceid', 'vtiger_inventoryproductrel' => 'id'];
    ...
    public function get_invoicestatushistory($id)
    {
        ...
        $invoicestatus_array = ($invoicestatus_access != 1) ? $picklistarray['invoicestatus'] : [];
    ...
    public function generateReportsSecQuery($module, $secmodule, $queryPlanner)
    {
        ...
        $matrix->setDependency('vtiger_invoice', ['vtiger_crmentityInvoice', "vtiger_currency_info{$secmodule}",
    ...
    {
        $rel_tables =  [
            'Calendar' => ['vtiger_seactivityrel' => ['crmid', 'activityid'], 'vtiger_invoice' => 'invoiceid'],
