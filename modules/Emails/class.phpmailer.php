...
class PHPMailer
{
    ...
    public function setFrom($address, $name = '', $auto = true)
    {
        ...
        if (($pos = strrpos($address, '@')) === false
            or (!$this->has8bitChars(substr($address, ++$pos)) or !$this->idnSupported())
            and !$this->validateAddress($address)) {
    ...
    public function punyencodeAddress($address)
    {
        ...
        if ($this->idnSupported()
            and !empty($this->CharSet)
            and ($pos = strrpos($address, '@')) !== false) {
    ...
    public function DKIM_Sign($signHeader)
    {
        ...
        if (version_compare(PHP_VERSION, '5.3.0') >= 0
            and in_array('sha256WithRSAEncryption', openssl_get_md_methods(true))) {
