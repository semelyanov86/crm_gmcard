...
if (defined('VTIGER_UPGRADE')) {
    ...
    if ($adb->num_rows($result) <= 0) {
        Migration_Index_View::ExecuteQuery('INSERT INTO vtiger_currencies VALUES (?,?,?,?)', [$uniqId, 'CFP Franc', 'XPF', 'F']);
    }
    ...
    if ($adb->num_rows($sortOrderResult)) {
        ...
        Migration_Index_View::ExecuteQuery('INSERT INTO vtiger_time_zone (time_zone, sortorderid, presence) VALUES (?, ?, ?)', ['Etc/GMT-11', $sortOrderId + 1, 1]);
