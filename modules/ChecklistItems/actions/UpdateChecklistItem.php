...
class ChecklistItems_UpdateChecklistItem_Action extends Vtiger_Save_Action
{
    ...
    public function updateStatus($request)
    {
        ...
        $recordModel->save();
        $result = ['status' => $statusValue, 'currDate' => $currDateDisplay, 'currTime' => $currTimeDisplay];
        $response = new Vtiger_Response();
        $response->setResult($result);
        $response->emit();
        exit;
    ...
    public function updateDateTime($request)
    {
        ...
        if ($datetime) {
            [$new_date, $new_time] = explode(' ', $datetime);
        ...
        $result = ['currDate' => $currDateDisplay, 'currTime' => $currTimeDisplay];
        $response = new Vtiger_Response();
        $response->setResult($result);
        $response->emit();
        exit;
