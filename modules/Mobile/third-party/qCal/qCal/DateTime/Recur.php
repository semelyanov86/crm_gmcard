...
abstract class qCal_DateTime_Recur
{
    ...
    /**
     * @var int The amount of recurrences
     */
    protected $count;

    /**
     * @var int Interval of recurrence (for every 3 days, "3" would be the interval)
     */
    protected $interval;

    /**
     * @var int|array An integer between 0 and 59 (for multiple, set as an array)
     */
    protected $bysecond;

    /**
     * @var int|array An integer between 0 and 59 (or an array of integers for multiple)
     */
    protected $byminute;

    /**
     * @var int|array An integer or array of integers between 0 and 23
     */
    protected $byhour;
    ...
    /**
     * @var int|array An integer or array of integers. -31 to -1 or 1 to 31. -10 would mean the tenth to last
     * day of the month. [1,5,-5] would be the 1st, 5th, and 5th to last days of the month
     */
    protected $bymonthday;

    /**
     * @var int|array An integer or array of integers. -366 to -1 or 1 to 366. -306 represents the 306th to last
     * day of the year (March 1st)
     */
    protected $byyearday;

    /**
     * @var int|array An integer or array of integers. -53 to -1 or 1 to 53. Only valid for yearly rules.
     * 3 represents the third week of the year.
     */
    protected $byweekno;

    /**
     * @var int|array An integer or array of integers. 1 to 12. 3 would represent March
     */
    protected $bymonth;

    /**
     * @var int If present, it indicates the nth occurrence of the specific occurrence within the set of
     ...
     * This is a getter as well as a setter (if no arg is supplied, it is a getter).
     * @param int|array Must be between 1 and 31 or -31 to 1 (or an array of those values)
     * @return self
     * @throws qCal_DateTime_Exception_InvalidRecur
     */
     ...
     * This is a getter as well as a setter (if no arg is supplied, it is a getter).
     * @param int|array must be between 1 and 366 or -366 to -1
     * @return self
     * @throws qCal_DateTime_Exception_InvalidRecur
     */
     ...
     * This is a getter as well as a setter (if no arg is supplied, it is a getter).
     * @param int|array must be between 1 and 53 or -53 to -1
     * @return self
     * @throws qCal_DateTime_Exception_InvalidRecur
     */
     ...
     * This is a getter as well as a setter (if no arg is supplied, it is a getter).
     * @param int|array Must be between 1 and 12
     * @return self
     * @throws qCal_DateTime_Exception_InvalidRecur
     */
