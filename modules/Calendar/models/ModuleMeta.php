...
class Calendar_ModuleMeta_Model extends Vtiger_ModuleMeta_Model
{
    public function getMergableFields()
    {
        ...
        $skippedFields = ['duration_hours', 'duration_minutes', 'recurringtype', 'reminder_time', 'time_start', 'time_end'];
    ...
    public function getImportableFields()
    {
        ...
        $skippedFields = ['duration_hours', 'duration_minutes', 'recurringtype', 'reminder_time'];
