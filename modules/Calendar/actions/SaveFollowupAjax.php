...
class Calendar_SaveFollowupAjax_Action extends Calendar_SaveAjax_Action
{
    ...
    public function createFollowupEvent(Vtiger_Request $request)
    {
        ...
        [$followupStartDate, $followupStartTime] = explode(' ', $followupStartDateTime);
        ...
        [$followupEndDate, $followupEndTime] = explode(' ', $followupEndDateTime);
    ...
    public function setRecurrenceInfo($recordModel)
    {
        ...
        if ($recurringInfo['eventrecurringtype'] == 'Monthly') {
            ...
            } elseif ($recurringInfo['repeatMonth'] == 'day') {
