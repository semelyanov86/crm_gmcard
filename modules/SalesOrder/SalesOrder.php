...
class SalesOrder extends CRMEntity
{
    ...
    public $tab_name = ['vtiger_crmentity', 'vtiger_salesorder', 'vtiger_sobillads', 'vtiger_soshipads', 'vtiger_salesordercf', 'vtiger_invoice_recurring_info', 'vtiger_inventoryproductrel'];

    public $tab_name_index = ['vtiger_crmentity' => 'crmid', 'vtiger_salesorder' => 'salesorderid', 'vtiger_sobillads' => 'sobilladdressid', 'vtiger_soshipads' => 'soshipaddressid', 'vtiger_salesordercf' => 'salesorderid', 'vtiger_invoice_recurring_info' => 'salesorderid', 'vtiger_inventoryproductrel' => 'id'];
    ...
    public $sortby_fields = ['subject', 'smownerid', 'accountname', 'lastname'];
    ...
    public function get_sostatushistory($id)
    {
        ...
        $sostatus_array = ($sostatus_access != 1) ? $picklistarray['sostatus'] : [];
    ...
    public function generateReportsSecQuery($module, $secmodule, $queryPlanner)
    {
        ...
        $matrix->setDependency('vtiger_salesorder', ['vtiger_crmentitySalesOrder', "vtiger_currency_info{$secmodule}",
    ...
    {
        $rel_tables =  [
            'Calendar' => ['vtiger_seactivityrel' => ['crmid', 'activityid'], 'vtiger_salesorder' => 'salesorderid'],
            'Invoice' => ['vtiger_invoice' => ['salesorderid', 'invoiceid'], 'vtiger_salesorder' => 'salesorderid'],
