...
$cvcolumns = [['vtiger_leaddetails:lead_no:lead_no:Leads_Lead_No:V',
    ...
    ['vtiger_activity:status:taskstatus:Calendar_Status:V',
    ...
    ['vtiger_activity:subject:subject:Emails_Subject:V',
...
$cvstdfilters = [['columnname' => 'vtiger_crmentity:modifiedtime:modifiedtime:Leads_Modified_Time',
...
function insertCvAdvFilter($CVid, $filters)
{
    ...
    if ($CVid != '') {
        ...
        $adb->pquery('INSERT INTO vtiger_cvadvfilter_grouping VALUES(?,?,?,?)', [1, $CVid, '', $conditionExpression]);
    }
}
