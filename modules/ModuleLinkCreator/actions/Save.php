...
class ModuleLinkCreator_Save_Action extends Vtiger_Action_Controller
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        if ($module) {
            ...
            $otherFields = array($module->name => array($baseBlockLabel => array((string) $lowerModuleName . "no" => array("label" => (string) $singular_module_label . " No", "table" => $module_basetable, "uitype" => 4, "summaryfield" => 0, "masseditable" => 0), "created_user_id" => array("label" => vtranslate("Created By"), "uitype" => 52, "columnname" => "smcreatorid", "summaryfield" => 0, "masseditable" => 0, "table" => $tblCrmentity, "displaytype" => 2), "modifiedby" => array("label" => vtranslate("Modified By"), "uitype" => 52, "presence" => 0, "summaryfield" => 0, "masseditable" => 0, "table" => $tblCrmentity, "displaytype" => 2)), "LBL_DESCRIPTION" => array("description" => array("label" => vtranslate("Description"), "uitype" => 19, "table" => $tblCrmentity, "quickcreate" => 0, "summaryfield" => 1, "quickcreatesequence" => 3, "filter" => array("name" => "All", "isdefault" => false)))));
            if (version_compare($vtiger_current_version, "7.0.0", ">=")) {
                $otherFields[$module->name][$baseBlockLabel]["tags"] = array("label" => vtranslate("tags"), "uitype" => 1, "readonly" => 1, "presence" => 2, "summaryfield" => 0, "masseditable" => 0, "columntype" => "varchar(1)", "table" => $module_basetable, "typeofdata" => "V~O", "quickcreate" => 3, "displaytype" => 6);
                ...
                $otherFields[$module->name][$baseBlockLabel]["starred"] = array("label" => vtranslate("starred"), "uitype" => 56, "presence" => 2, "readonly" => 1, "summaryfield" => 0, "masseditable" => 0, "columntype" => "varchar(1)", "table" => $tableStarred, "typeofdata" => "C~O", "quickcreate" => "3", "displaytype" => 6);
                $otherFields[$module->name][$baseBlockLabel]["source"] = array("label" => "Source", "uitype" => 1, "presence" => 2, "readonly" => 1, "masseditable" => 0, "table" => "vtiger_crmentity", "typeofdata" => "V~O", "quickcreate" => "3", "displaytype" => 2);
            }
            ...
            $adb->pquery($sql1, array($module->id));
            $customBlock = Vtiger_Block_Model::getInstance("LBL_CUSTOM_INFORMATION", $module);
            $customBlockFields = array("created_user_id", "createdtime", "modifiedby", "modifiedtime", "source");
            if ($customBlock) {
