...
/**
 * Class ModuleLinkCreator_VTELicense_Model
 */
class ModuleLinkCreator_VTELicense_Model
{
    /**
    ...
    public $license = "";
    /**
     * ModuleLinkCreator_VTELicense_Model constructor.
     * @param string $module
     */
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery("DELETE FROM `vte_modules` WHERE module=?;", array("ModuleLinkCreator"));
        $adb->pquery("INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);", array("ModuleLinkCreator", "0"));
        return false;
    }
