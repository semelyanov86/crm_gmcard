...
class Reports_ListView_Model extends Vtiger_ListView_Model
{
    ...
    {
        $headers = [
            'reporttype' => ['label' => 'Report Type', 'type' => 'picklist'],
            'reportname' => ['label' => 'Report Name', 'type' => 'string'],
            'primarymodule' => ['label' => 'Primary Module', 'type' => 'picklist'],
            'foldername' => ['label' => 'LBL_FOLDER_NAME', 'type' => 'picklist'],
            'owner' => ['label' => 'LBL_OWNER', 'type' => 'picklist'],
        ];
        if ($folderId == 'shared') {
    ...
    {
        [$folderId] = func_get_args();
        $headers = [
            'reportname' => ['label' => 'LBL_REPORT_NAME', 'type' => 'string'],
            'description' => ['label' => 'LBL_DESCRIPTION', 'type' => 'string'],
            'reporttype' => ['label' => 'Report Type', 'type' => 'picklist'],
        ];
