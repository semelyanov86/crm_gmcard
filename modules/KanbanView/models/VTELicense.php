...
class KanbanView_VTELicense_Model
{
    public $module = "";
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery("DELETE FROM `vte_modules` WHERE module=?;", array("KanbanView"));
        $adb->pquery("INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);", array("KanbanView", "0"));
        return false;
    }
