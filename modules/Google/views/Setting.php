...
class Google_Setting_View extends Vtiger_PopupAjax_View
{
    ...
    public function intializeContactsSyncSettingParameters(Vtiger_Request $request)
    {
        ...
        $mandatoryMapFields = ['salutationtype', 'firstname', 'lastname', 'title', 'account_id', 'birthday',
        ...
        $skipFields = ['reference', 'contact_id', 'leadsource', 'assigned_user_id', 'donotcall', 'notify_owner',
        ...
        $emailFields = $phoneFields = $urlFields = $otherFields = [];
        $disAllowedFieldTypes = ['reference', 'picklist', 'multipicklist'];
