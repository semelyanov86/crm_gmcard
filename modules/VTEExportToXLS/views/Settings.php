...
class VTEExportToXLS_Settings_View extends Settings_Vtiger_Index_View
{
    ...
    public function renderSettingsUI(Vtiger_Request $request)
    {
        ...
        $module = $request->getModule();
        $viewer = $this->getViewer($request);
        $rs = $adb->pquery("SELECT `enable`,custom_filename, file_name, download_to_server FROM `vteexport_to_xls_settings`;", array());
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("~/libraries/jquery/bootstrapswitch/js/bootstrap-switch.min.js", "modules.VTEExportToXLS.resources.Settings");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~/libraries/jquery/bootstrapswitch/css/bootstrap3/bootstrap-switch.min.css");
