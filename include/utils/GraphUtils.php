...
function color_generator($count = 1, $start = '33CCFF', $step = '221133')
{
    ...
    $colors = [hexdec(substr($start, 0, 2)), hexdec(substr($start, 2, 2)), hexdec(substr($start, 4, 2))];
    $steps = [hexdec(substr($step, 0, 2)), hexdec(substr($step, 2, 2)), hexdec(substr($step, 4, 2))];
