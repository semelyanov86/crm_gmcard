...
class RecurringType
{
    ...
    public function getUserRecurringInfo()
    {
        ...
        if ($recurringType == 'Weekly') {
            ...
            $dbStartDateTime = new DateTimeImmutable($this->startdate->get_DB_formatted_date() . ' ' . $this->startdate->get_formatted_time());
    ...
    public function _getRecurringDates()
    {
        ...
        while ($tempdate <= $enddate) {
            ...
            if ($this->recur_type == 'Daily') {
                ...
                if ($index > 2_037 || $index < 1_970) {
                    echo "<font color='red'>" . $app_strings['LBL_CAL_LIMIT_MSG'] . '</font>';
                    exit;
                }
                $date_arr = [
                    'day' => $date,
                ...
                exit('Recurring Type ' . $this->recur_type . ' is not defined');
            }
        }
