...
function vtws_listtypes($fieldTypeList, $user)
{
    ...
    foreach ($accessibleModules as $module) {
        ...
        $informationArray[$module] = ['isEntity' => true, 'label' => getTranslatedString($module, $vtigerModule),
    ...
    foreach ($accessibleEntities as $entity) {
        ...
        $informationArray[$entity] = ['isEntity' => false, 'label' => $label,
            'singular' => $singular];
    }

    VTWS_PreserveGlobal::flush();
    $types[$user->id][$fieldTypeString] = ['types' => array_merge($accessibleModules, $accessibleEntities),
