...
class VtigerActorOperation extends WebserviceEntityOperation
{
    ...
    public function __create($elementType, $element)
    {
        ...
        $result = null;
        $transactionSuccessful = vtws_runQueryAsTransaction(
            $query,
    ...
    public function __retrieve($id)
    {
        ...
        $transactionSuccessful = vtws_runQueryAsTransaction($query, [$id], $result);
    ...
    public function describe($elementType)
    {
        ...
        return ['label' => $label, 'name' => $elementType, 'createable' => $createable, 'updateable' => $updateable,
    ...
    public function getDescribeFieldArray($webserviceField)
    {
        ...
        $describeArray = ['name' => $webserviceField->getFieldName(), 'label' => $fieldLabel, 'mandatory' => $webserviceField->isMandatory(), 'type' => $typeDetails, 'nullable' => $webserviceField->isNullable(),
            'editable' => $editable];
