...
class VTQL_Parser // line 102 "e:\workspace\nonadmin\pkg\vtiger\extensions\Webservices\VTQL_parser.php"
{
    ...
    ** in the input file. */
    ...
    public function buildSelectStmt($sqlDump)
    {
        ...
        } elseif (in_array('count(*)', $sqlDump['column_list'])) {
                ...
                for (; $i < php7_sizeof($sqlDump['where_condition']['column_values']); ++$i) {
                    ...
                    if (in_array($whereField, array_keys($referenceFields))) {
                        if (is_array($whereValue)) {
                            ...
                            $whereValue = array_map([$this, 'getReferenceValue'], $whereValue);
                        } elseif (strpos($whereValue, 'x') !== false) {
                    ...
                    } elseif (in_array($whereField, $ownerFields)) {
                        if (is_array($whereValue)) {
                            $groupId = array_map([$this, 'getOwner'], $whereValue);
                        } else {
    ...
    */
    ...
    public const FRM                            =  2;
    public const COLUMNNAME                     =  3;
    public const ASTERISK                       =  4;
    public const COUNT                          =  5;
    public const PARENOPEN                      =  6;
    public const PARENCLOSE                     =  7;
    public const COMMA                          =  8;
    public const TABLENAME                      =  9;
    public const WHERE                          = 10;
    public const LOGICAL_AND                    = 11;
    public const LOGICAL_OR                     = 12;
    public const VALUE                          = 13;
    public const EQ                             = 14;
    public const LT                             = 15;
    public const GT                             = 16;
    public const LTE                            = 17;
    ...
    public const NE                             = 19;
    public const IN                             = 20;
    public const LIKE                           = 21;
    public const ORDERBY                        = 22;
    public const ASC                            = 23;
    public const DESC                           = 24;
    public const LIMIT                          = 25;
    public const SEMICOLON                      = 26;
    public const YY_NO_ACTION = 102;
    public const YY_ACCEPT_ACTION = 101;
    public const YY_ERROR_ACTION = 100;
    ...
    */
    ...
    public const YY_SHIFT_USE_DFLT = -15;
    public const YY_SHIFT_MAX = 27;
    ...
    public const YY_REDUCE_USE_DFLT = -34;
    public const YY_REDUCE_MAX = 14;
    ...
    */
    public const YYNOCODE = 50;
    public const YYSTACKDEPTH = 100;
    public const YYNSTATE = 58;
    public const YYNRULE = 42;
    public const YYERRORSYMBOL = 27;
    ...
    */
    ...
    {
        $this->out['where_condition']['column_values'] ??= [];
    ...
    public function yy_r41()
    {
        ...
        if (!isset($this->out['meta'])) {
            ...
            if (isset($this->out['where_condition'], $this->out['where_condition']['column_names'])) {
            ...
            if (!isset($this->out['defaultJoinConditons'])) {
