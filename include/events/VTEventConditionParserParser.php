...
class VTEventConditionParserParser extends AntlrParser
{
    ...
    {
        return VTEventConditionParserParser::$tokenNames;
    }
    ...
    public function comparision()
    {
        ...
        try {
            ...
            if ($this->state->backtracking == 0) {
                $result = ['==', new VTEventConditionSymbol($lhs != null ? $lhs->getText() : null), $rhs];
                echo $value;
            }
    ...
    public function inclause()
    {
        ...
        try {
            ...
            if ($this->state->backtracking == 0) {
                $result = ['in', new VTEventConditionSymbol($lhs != null ? $lhs->getText() : null), $rhs];
            }
...
VTEventConditionParserParser::$FOLLOW_comparision_in_statement57 = new Set([1]);
VTEventConditionParserParser::$FOLLOW_inclause_in_statement63 = new Set([1]);
VTEventConditionParserParser::$FOLLOW_SYMBOL_in_comparision78 = new Set([13]);
VTEventConditionParserParser::$FOLLOW_13_in_comparision80 = new Set([6]);
VTEventConditionParserParser::$FOLLOW_value_in_comparision84 = new Set([1]);
VTEventConditionParserParser::$FOLLOW_SYMBOL_in_inclause101 = new Set([5]);
VTEventConditionParserParser::$FOLLOW_IN_in_inclause103 = new Set([14]);
VTEventConditionParserParser::$FOLLOW_listelement_in_inclause107 = new Set([1]);
VTEventConditionParserParser::$FOLLOW_14_in_listelement122 = new Set([6]);
VTEventConditionParserParser::$FOLLOW_value_in_listelement126 = new Set([15, 16]);
VTEventConditionParserParser::$FOLLOW_15_in_listelement137 = new Set([6]);
VTEventConditionParserParser::$FOLLOW_value_in_listelement141 = new Set([15, 16]);
VTEventConditionParserParser::$FOLLOW_16_in_listelement147 = new Set([1]);
VTEventConditionParserParser::$FOLLOW_STRING_in_value162 = new Set([1]);
