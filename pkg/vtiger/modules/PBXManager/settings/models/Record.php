...
{
    public const tableName = 'vtiger_pbxmanager_gateway';
    ...
    {
        $db = PearDatabase::getInstance();
        $result = $db->pquery('SELECT * FROM ' . self::tableName . ' WHERE id = ?', [$recordId]);
    ...
    public function save()
    {
        ...
        $params = [$selectedGateway, $this->get('parameters')];
        $id = $this->getId();
