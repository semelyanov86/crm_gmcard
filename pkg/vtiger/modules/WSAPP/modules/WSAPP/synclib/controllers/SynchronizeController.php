...
{
    public const WSAPP_SYNCHRONIZECONTROLLER_USER_SYNCTYPE = 'user';
    public const WSAPP_SYNCHRONIZECONTROLLER_APP_SYNCTYPE = 'app';
    public const WSAPP_SYNCHRONIZECONTROLLER_USERANDGROUP_SYNCTYPE = 'userandgroup';
    public const WSAPP_SYNCHRONIZECONTROLLER_PULL_EVENT = 'pull';
    public const WSAPP_SYNCHRONIZECONTROLLER_PUSH_EVENT = 'push';
