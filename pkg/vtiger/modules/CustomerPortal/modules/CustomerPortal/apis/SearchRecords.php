            ...
            if (!empty($searchKey)) {
                ...
                if (!empty($portalActiveModules)) {
                    ...
                    foreach ($portalActiveModules as $key => $module) {
                        ...
                        if (in_array($module, ['Faq', 'ProjectTask', 'ProjectMilestone'])) {
                            // do nothing
                        } else {
                            ...
                            foreach ($activeFields as $key => $field) {
                                ...
                                if (in_array($field_model->getFieldDataType(), ['date', 'datetime', 'time', 'currency'])) {
                ...
                throw new Exception('Search key is empty', 1_412);
            }
