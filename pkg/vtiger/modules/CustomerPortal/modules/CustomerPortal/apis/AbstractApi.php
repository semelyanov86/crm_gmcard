...
abstract class CustomerPortal_API_Abstract
{
    ...
    public function authenticatePortalUser($username, $password)
    {
        ...
        $result = $adb->pquery($sql, [$username, $current_date, $current_date]);
    ...
    protected function relatedRecordIds($module, $moduleLabel, $parentId = null)
    {
        ...
        if ($parentId == null) {
            ...
            if ($mode == 'mine') {
                ...
                if (in_array($module, ['Products', 'Services'])) {
    ...
    protected function isRecordAccessible($recordId, $module = null, $moduleLabel = null)
    {
        ...
        if (in_array($recordId, $relatedIds) || ($mode == 'all' && in_array($module, ['Products', 'Services']))) {
            return true;
        }
