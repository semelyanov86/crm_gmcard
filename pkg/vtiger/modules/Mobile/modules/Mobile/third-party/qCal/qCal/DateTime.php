...
class qCal_DateTime
{
    ...
    public static function factory($datetime, $timezone = null)
    {
        ...
        [$year, $month, $day, $hour, $minute, $second] = explode('|', gmdate('Y|m|d|H|i|s', $timestamp));
    ...
    public function getUtc($humanReadable = false)
    {
        ...
        if ($humanReadable) {
            return gmdate('Y-m-d', $this->date->getUnixTimestamp()) . gmdate('\TH:i:s\Z', $this->time->getTimestamp());
        }
