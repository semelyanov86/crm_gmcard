...
class qCal_Timezone
{
    ...
    public function setIsDaylightSavings($daylightSavings = null)
    {
        ...
        $this->isDaylightSavings = (bool) $daylightSavings;
     ...
     * @see http://php.net/manual/en/timezones.php A directory of valid timezones
    ...
    public static function factory($timezone = null)
    {
        ...
        if (is_array($timezone)) {
            ...
            $vals = array_intersect_key($timezone, array_flip(['name', 'offsetSeconds', 'abbreviation', 'isDaylightSavings']));
