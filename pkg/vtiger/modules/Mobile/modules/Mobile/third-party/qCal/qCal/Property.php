...
abstract class qCal_Property
{
     ...
     */
    public function __construct($value = null, $params = [])
    {
     ...
     */
    public static function factory($name, $value, $params = [])
    {
     ...
     * @return bool True if this is a property of $component, false otherwise
     */
    ...
    protected function getClassNameFromPropertyName($name)
    {
        ...
        foreach ($parts as $part) {
            $property .= trim(ucfirst(strtolower($part)));
        }
