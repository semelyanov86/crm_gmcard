...
class SMSNotifier_ClickATellNew_Provider implements SMSNotifier_ISMSProvider_Model
{
    ...
    private static $REQUIRED_PARAMETERS = [['name' => 'callback', 'label' => 'Enable delivery notifications URL', 'type' => 'url'], ['name' => 'api_key', 'label' => 'API Key', 'type' => 'text']];
    ...
    public function updateMessageStatus(Vtiger_Request $request)
    {
