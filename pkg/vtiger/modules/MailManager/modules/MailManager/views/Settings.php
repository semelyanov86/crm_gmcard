...
class MailManager_Settings_View extends MailManager_MainUI_View
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        if ($this->getOperationArg($request) == 'edit') {
        ...
        } elseif ($this->getOperationArg($request) == 'save') {
        ...
        } elseif ($this->getOperationArg($request) == 'remove') {
        ...
        } elseif ($this->getOperationArg($request) == 'detail') {
