...
$languageStrings = [
    ...
    'LBL_RECORDS_LIST' => 'Lista de Fornecedores',

    // Blocks
    'LBL_VENDOR_INFORMATION' => 'Detalhes Fornecedor',
    'LBL_VENDOR_ADDRESS_INFORMATION' => 'Detalhes Endereço',

    // Field Labels
    'Vendor Name' => 'Nome Fornecedor',
    'Vendor No' => 'No. Fornecedor',
    'Website' => 'Website',
...
$jsLanguageStrings = [
    'LBL_RELATED_RECORD_DELETE_CONFIRMATION' => 'Você tem certeza que deseja apagar?',
    ...
    'LBL_MASS_DELETE_CONFIRMATION' => 'Ao apagar este(s) Fornecedor(s), os Pedidos de Compras relacionados serão removidos. Tem certeza que deseja apagar os Registros selacionados?',
];
