...
$languageStrings = [
    ...
    'LBL_USE_SAVED_MAPS' => 'Использовать Сохраненные Карты',
    'LBL_IMPORT_MAP_FIELDS' => 'Карты в огонь, чтобы поля CRM',
    'LBL_UPLOAD_CSV' => 'Загрузить CSV файл',
    'LBL_UPLOAD_VCF' => 'Загрузить файл vcf',
    'LBL_DUPLICATE_HANDLING' => 'Дубликат Обращения',
    'LBL_FIELD_MAPPING' => 'Сопоставления Полей',
    ...
    'LBL_DUPLICATE_RECORD_HANDLING' => 'Повторяющаяся запись обработка',
