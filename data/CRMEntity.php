...
class CRMEntity
{
    ...
    public function saveentity($module, $fileid = '')
    {
        ...
        if (!$anyValue) {
            exit('<center>' . getTranslatedString('LBL_MANDATORY_FIELD_MISSING') . '</center>');
        }
    ...
    public function getJoinClause($tableName)
    {
        ...
        if (Vtiger_Functions::isUserSpecificFieldTable($tableName, $this->moduleName)) {
            return 'LEFT JOIN';
        }
...
class TrackableObject implements ArrayAccess, IteratorAggregate
{
    ...
    public function offsetSet($key, $value)
    {
        ...
        } // it is an associative (if array without a key 0) modified to prevent warning of Undefined array key 0 .
