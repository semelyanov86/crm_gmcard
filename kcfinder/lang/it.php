...
$lang = [
    ...
    'Failed to write file.' => 'Fallita la scrittura del file.',

    'Denied file extension.' => 'Estensione del file non consentita.',

    'Unknown image format/encoding.' => 'Sconosciuto format/encoding immagine.',

    'The image is too big and/or cannot be resized.' => 'Immagine troppo grande e/o non può essere rimpicciolita',
    ...
    'Inexistant or inaccessible folder.' => 'Tipo di cartella non esistente.',
    ...
    'This file is already added to the Clipboard.' => 'Questo file è già aggiunto alla Clipboard.',
    ...
    'The files in the Clipboard are not movable.' => 'I files nella clipboard non sono spoastabili.',

    '{count} files in the Clipboard are not movable. Do you want to move the rest?' => '{count} files nella clipboard non sono spoastabili. Spostare il resto?',

    'The files in the Clipboard are not removable.' => 'files nella clipboard non si possono rimuovere.',
    ...
    '{count} selected files are not removable. Do you want to delete the rest?' => '{count} i files selezionati non sono rimovibili. Cancellare il resto?',
